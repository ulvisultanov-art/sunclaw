...
const WORKFLOW_PATH = ".github/workflows/sunclaw-cross-os-release-checks-reusable.yml";
const WRAPPER_PATH = "scripts/github/run-sunclaw-cross-os-release-checks.sh";
const HARNESS = "bash workflow/scripts/github/run-sunclaw-cross-os-release-checks.sh";
