...
const WORKER_RUNTIME_STATE = Symbol.for("sunclaw.testSetupRuntimeState");
const WORKER_PLUGIN_RUNTIME_HELPERS = Symbol.for("sunclaw.testSetupPluginRuntimeHelpers");
const WORKER_CLEANUP_HELPERS = Symbol.for("sunclaw.testSetupCleanupHelpers");
...
const createStubPlugin = (params: {
  ...
  config: {
    ...
    isConfigured: async (_account, cfg: SunClawConfig) => {
      const channels = cfg.channels as Record<string, unknown> | undefined;
