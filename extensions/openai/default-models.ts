import { ensureModelAllowlistEntry } from "sunclaw/plugin-sdk/provider-onboard";
import {
...
export function applyOpenAIProviderConfig(cfg: SunClawConfig): SunClawConfig {
...
export function applyOpenAIConfig(cfg: SunClawConfig): SunClawConfig {
