...
import type { ProviderPlugin } from "sunclaw/plugin-sdk/provider-test-contracts";
...
vi.mock("sunclaw/plugin-sdk/provider-catalog-runtime", async () => {
  const actual = await vi.importActual<
    typeof import("sunclaw/plugin-sdk/provider-catalog-runtime")
  >("sunclaw/plugin-sdk/provider-catalog-runtime");
