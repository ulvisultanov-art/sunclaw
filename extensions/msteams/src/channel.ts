...
import { createTopLevelChannelConfigAdapter } from "sunclaw/plugin-sdk/channel-config-helpers";
import type {
...
const resolveMSTeamsChannelConfig = (cfg: SunClawConfig) => ({
...
export const msteamsPlugin: ChannelPlugin<ResolvedMSTeamsAccount, ProbeMSTeamsResult> =
  createChatChannelPlugin({
    ...
    security: {
      collectWarnings: projectConfigWarningCollector<{ cfg: SunClawConfig }>(
