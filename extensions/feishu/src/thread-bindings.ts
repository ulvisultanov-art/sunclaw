...
import { normalizeAccountId, resolveAgentIdFromSessionKey } from "sunclaw/plugin-sdk/routing";
...
const FEISHU_THREAD_BINDINGS_STATE_KEY = Symbol.for("sunclaw.feishuThreadBindingsState");
