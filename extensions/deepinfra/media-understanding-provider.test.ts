...
vi.mock("sunclaw/plugin-sdk/media-understanding", async () => {
  const actual = await vi.importActual<typeof import("sunclaw/plugin-sdk/media-understanding")>(
    "sunclaw/plugin-sdk/media-understanding",
  );
  return {
    ...actual,
...
afterAll(() => {
  vi.doUnmock("sunclaw/plugin-sdk/media-understanding");
  vi.resetModules();
});
