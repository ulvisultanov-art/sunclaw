...
function ensureZalouserPluginEnabled(cfg: SunClawConfig): SunClawConfig {
      ...
      await prompter.note(
        [
          ...
          t("wizard.zalouser.peersLookupTip", {
            command: formatCliCommand("sunclaw directory peers list --channel zalouser"),
          }),
        ].join("\n"),
        ...
        await prompter.note(
          [
            ...
            t("wizard.zalouser.groupsLookupTip", {
              command: formatCliCommand("sunclaw directory groups list --channel zalouser"),
            }),
