...
} from "sunclaw/plugin-sdk/agent-harness";
import { createTokenjuiceSunClawEmbeddedExtension } from "./runtime-api.js";

type TokenjuiceToolResultHandler = (
  event: {
    toolName: string;
    input: Record<string, unknown>;
    content: SunClawAgentToolResult["content"];
    details: unknown;
    isError?: boolean;
  },
  ctx: { cwd: string },
) => Promise<Partial<SunClawAgentToolResult> | void> | Partial<SunClawAgentToolResult> | void;
