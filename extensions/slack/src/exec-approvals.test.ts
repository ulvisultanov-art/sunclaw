...
function buildConfig(
  execApprovals?: NonNullable<NonNullable<SunClawConfig["channels"]>["slack"]>["execApprovals"],
  channelOverrides?: Partial<NonNullable<NonNullable<SunClawConfig["channels"]>["slack"]>>,
): SunClawConfig {
  return {
    channels: {
      slack: {
