...
type BuildCommandTextFromArgs =
  typeof import("sunclaw/plugin-sdk/command-auth-native").buildCommandTextFromArgs;
type FindCommandByNativeName =
  typeof import("sunclaw/plugin-sdk/command-auth-native").findCommandByNativeName;
type ListNativeCommandSpecsForConfig =
  typeof import("sunclaw/plugin-sdk/command-auth-native").listNativeCommandSpecsForConfig;
type ParseCommandArgs = typeof import("sunclaw/plugin-sdk/command-auth-native").parseCommandArgs;
type ResolveCommandArgMenu =
  typeof import("sunclaw/plugin-sdk/command-auth-native").resolveCommandArgMenu;
