...
import { resolveDefaultAgentId } from "sunclaw/plugin-sdk/agent-runtime";
...
import type { DmPolicy, GroupPolicy } from "sunclaw/plugin-sdk/config-contracts";
import { resolveRuntimeConversationBindingRoute } from "sunclaw/plugin-sdk/conversation-runtime";
import { createDedupeCache } from "sunclaw/plugin-sdk/dedupe-runtime";
...
export type SlackMonitorContext = {
  ...
  slashCommand: Required<import("sunclaw/plugin-sdk/config-contracts").SlackSlashCommandConfig>;
  textLimit: number;
