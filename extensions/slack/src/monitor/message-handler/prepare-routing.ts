...
type SlackRouteBinding = NonNullable<SunClawConfig["bindings"]>[number];
type SlackRouteBindingPeer = NonNullable<SlackRouteBinding["match"]["peer"]>;

const slackRouteBindingConfigCache = new WeakMap<
  SunClawConfig,
  { bindingsRef: SunClawConfig["bindings"]; normalizedCfg: SunClawConfig }
>();
...
function normalizeSlackRouteBindingConfig(cfg: SunClawConfig): SunClawConfig {
