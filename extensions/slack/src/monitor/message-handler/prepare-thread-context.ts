import { formatInboundEnvelope } from "sunclaw/plugin-sdk/channel-inbound";
import { runTasksWithConcurrency } from "sunclaw/plugin-sdk/concurrency-runtime";
import type { ContextVisibilityMode } from "sunclaw/plugin-sdk/config-contracts";
...
export async function resolveSlackThreadContextData(params: {
  ...
  envelopeOptions: ReturnType<
    typeof import("sunclaw/plugin-sdk/channel-inbound").resolveEnvelopeFormatOptions
  >;
