...
} from "sunclaw/plugin-sdk/allowlist-config-edit";
import { adaptScopedAccountAccessor } from "sunclaw/plugin-sdk/channel-config-helpers";
import {
...
} from "sunclaw/plugin-sdk/channel-send-result";
import {
  createChannelDirectoryAdapter,
  createRuntimeDirectoryLiveAdapter,
} from "sunclaw/plugin-sdk/directory-runtime";
import { createLazyRuntimeModule } from "sunclaw/plugin-sdk/lazy-runtime";
import { buildOutboundBaseSessionKey, type RoutePeer } from "sunclaw/plugin-sdk/routing";
import {
...
//
// `sunclaw/plugin-sdk/channel-policy` is intentionally NOT lazy here —
...
const EXTENSION_SHARED_MODULE_ID = "sunclaw/plugin-sdk/extension-shared";
const TARGET_RESOLVER_RUNTIME_MODULE_ID = "sunclaw/plugin-sdk/target-resolver-runtime";
  ...
  base: {
    ...
    actions: createSlackActions(SLACK_CHANNEL, {
      invoke: async (action, cfg, toolContext) =>
        ...
        )(action, cfg as SunClawConfig, toolContext as SlackActionContext | undefined),
    }),
