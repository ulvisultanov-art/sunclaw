import { DEFAULT_ACCOUNT_ID, type SunClawConfig } from "sunclaw/plugin-sdk/account-resolution";
import { registerPluginHttpRoute } from "sunclaw/plugin-sdk/webhook-ingress";
