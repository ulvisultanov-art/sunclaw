...
function getChannelConfig(cfg: SunClawConfig): SynologyChatChannelConfig {
  return (cfg.channels?.[channel] as SynologyChatChannelConfig | undefined) ?? {};
}

function getRawAccountConfig(cfg: SunClawConfig, accountId: string): SynologyChatAccountRaw {
...
function isSynologyChatConfigured(cfg: SunClawConfig, accountId: string): boolean {
...
function resolveExistingAllowedUserIds(cfg: SunClawConfig, accountId: string): string[] {
