/**
 * Synology Chat Channel Plugin for SunClaw.
 *
...
import { createChatChannelPlugin, type ChannelPlugin } from "sunclaw/plugin-sdk/channel-core";
import { waitUntilAbort } from "sunclaw/plugin-sdk/channel-outbound";
import {
...
import { createEmptyChannelDirectoryAdapter } from "sunclaw/plugin-sdk/directory-runtime";
import {
...
const resolveSynologyChatDmPolicy = createScopedDmSecurityResolver<ResolvedSynologyChatAccount>({
  ...
  approveHint: "sunclaw pairing approve synology-chat <code>",
...
> & {
  pairing: {
    ...
    notifyApproval: (params: { cfg: SunClawConfig; id: string }) => Promise<void>;
  };
  security: {
    resolveDmPolicy: (params: { cfg: SunClawConfig; account: ResolvedSynologyChatAccount }) => {
  ...
  return createChatChannelPlugin({
    base: {
      ...
      meta: {
        ...
        blurb: "Connect your Synology NAS Chat to SunClaw",
        order: 90,
      },
      capabilities: {
