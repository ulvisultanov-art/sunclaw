...
import { resolveDangerousNameMatchingEnabled } from "sunclaw/plugin-sdk/dangerous-name-runtime";
...
/** Extract the channel config from the full SunClaw config object. */
function getChannelConfig(cfg: SunClawConfig): SynologyChatChannelConfig | undefined {
...
export function resolveAccount(
  ...
  const envBotName = process.env.SUNCLAW_BOT_NAME ?? "SunClaw";
