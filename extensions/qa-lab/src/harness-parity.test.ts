...
const LEFT: HarnessVariant = { id: "left", label: "Left", runtime: "sunclaw" };
const RIGHT: HarnessVariant = { id: "right", label: "Right", runtime: "sunclaw" };
...
describe("harness parity", () => {
  ...
  it("labels mock token estimates separately from live usage", () => {
    const sourceCell = makeCell("sunclaw", {
