...
import { resolvePreferredSunClawTmpDir } from "sunclaw/plugin-sdk/security-runtime";
import { asRecord, readStringValue } from "sunclaw/plugin-sdk/string-coerce-runtime";
...
function resolveTempPathParts(opts: { ext: string; tmpDir?: string; id?: string }) {
  const tmpDir = opts.tmpDir ?? resolvePreferredSunClawTmpDir();
  if (!opts.tmpDir) {
