/**
 * Voice call response generator - uses the embedded SunClaw agent for tool support.
...
/**
 * Generate a voice response using the embedded SunClaw agent with full tool support.
