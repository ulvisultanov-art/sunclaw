import { REALTIME_VOICE_AGENT_CONSULT_TOOL_POLICIES } from "sunclaw/plugin-sdk/realtime-voice";
import {
...
const VoiceCallRealtimeConfigSchema = z
  .object({
    ...
    /** Tool policy for the shared SunClaw agent consult tool. */
    toolPolicy: VoiceCallRealtimeToolPolicySchema.default("safe-read-only"),
    /** Guidance for when the realtime model should call the SunClaw agent consult tool. */
