...
function readLegacyGrokFallbackAuth(cfg?: SunClawConfig): XaiFallbackAuth | undefined {
...
function readLegacyGrokApiKeyResult(cfg?: SunClawConfig): ConfiguredRuntimeApiKeyResolution {
  const search = cfg?.tools?.web?.search;
  if (!search || typeof search !== "object") {
    return { status: "missing" };
  }
...
export function resolveFallbackXaiAuth(cfg?: SunClawConfig): XaiFallbackAuth | undefined {
...
export function resolveFallbackXaiApiKey(cfg?: SunClawConfig): string | undefined {
