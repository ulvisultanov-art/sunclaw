import type { ChannelConfigUiHint } from "sunclaw/plugin-sdk/core";

export const ircChannelConfigUiHints = {
  "": {
    label: "IRC",
    help: "IRC channel provider configuration and compatibility settings for classic IRC transport workflows. Use this section when bridging legacy chat infrastructure into SunClaw.",
  },
  dmPolicy: {
    label: "IRC DM Policy",
