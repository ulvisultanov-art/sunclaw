...
import { buildPluginConfigSchema } from "sunclaw/plugin-sdk/plugin-entry";
import { z } from "zod";
import type { SunClawPluginConfigSchema } from "../api.js";
import {
...
export const diffsPluginConfigSchema: SunClawPluginConfigSchema = {
