...
import { buildApprovalReactionPromptPayloadForRequest } from "sunclaw/plugin-sdk/approval-reaction-runtime";
import type {
  ExecApprovalRequest,
...
type ApprovalForwardingConfig = NonNullable<NonNullable<SunClawConfig["approvals"]>["exec"]>;
