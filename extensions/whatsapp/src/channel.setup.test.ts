import { createQueuedWizardPrompter } from "sunclaw/plugin-sdk/plugin-test-runtime";
...
vi.mock("sunclaw/plugin-sdk/setup", async () => {
  ...
  return {
    ...
    setSetupChannelEnabled: (cfg: SunClawConfig, channel: string, enabled: boolean) => ({
      ...cfg,
      channels: {
        ...cfg.channels,
        [channel]: {
          ...(cfg.channels?.[channel as keyof NonNullable<SunClawConfig["channels"]>] as object),
          enabled,
        },
      },
    }),
