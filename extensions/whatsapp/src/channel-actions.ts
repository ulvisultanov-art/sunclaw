...
function areWhatsAppAgentReactionsEnabled(params: { cfg: SunClawConfig; accountId?: string }) {
...
function hasAnyWhatsAppAccountWithAgentReactionsEnabled(cfg: SunClawConfig) {
