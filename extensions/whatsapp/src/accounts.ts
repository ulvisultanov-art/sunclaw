...
import type { DmPolicy, GroupPolicy, ReplyToMode } from "sunclaw/plugin-sdk/config-contracts";
import { resolveOAuthDir } from "sunclaw/plugin-sdk/state-paths";
...
export function listWhatsAppAuthDirs(cfg: SunClawConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: SunClawConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: SunClawConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: SunClawConfig): ResolvedWhatsAppAccount[] {
