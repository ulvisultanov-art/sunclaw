...
import { createConditionalWarningCollector } from "sunclaw/plugin-sdk/channel-policy";
...
const resolveSmsDmPolicy = createScopedDmSecurityResolver<ResolvedSmsAccount>({
  ...
  approveHint: "sunclaw pairing approve sms <code>",
...
export const smsPlugin: ChannelPlugin<ResolvedSmsAccount, SmsProbe> = createChatChannelPlugin({
  ...
  pairing: {
    text: {
      idLabel: "phoneNumber",
      message: "SunClaw: your SMS access has been approved.",
