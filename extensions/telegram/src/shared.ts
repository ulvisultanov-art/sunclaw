import { resolveNormalizedAccountEntry } from "sunclaw/plugin-sdk/account-core";
...
import { createChannelPluginBase, type ChannelPlugin } from "sunclaw/plugin-sdk/channel-core";
import { getChatChannelMeta } from "sunclaw/plugin-sdk/channel-plugin-common";
import type { SunClawConfig, TelegramAccountConfig } from "sunclaw/plugin-sdk/config-contracts";
 ...
 *
 * See: https://github.com/ulvisultanov-art/sunclaw/issues/53876
 */
function isBlockedByMultiBotGuard(cfg: SunClawConfig, accountId: string): boolean {
