...
import { isTruthyEnvValue, isWSL2Sync } from "sunclaw/plugin-sdk/runtime-env";
import { normalizeOptionalLowercaseString } from "sunclaw/plugin-sdk/string-coerce-runtime";

export const TELEGRAM_DISABLE_AUTO_SELECT_FAMILY_ENV =
  "SUNCLAW_TELEGRAM_DISABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_ENABLE_AUTO_SELECT_FAMILY_ENV = "SUNCLAW_TELEGRAM_ENABLE_AUTO_SELECT_FAMILY";
export const TELEGRAM_DNS_RESULT_ORDER_ENV = "SUNCLAW_TELEGRAM_DNS_RESULT_ORDER";
 ...
 *
 * Priority:
 * 1. Environment variable SUNCLAW_TELEGRAM_DNS_RESULT_ORDER
