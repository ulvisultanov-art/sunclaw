...
import { resolveApprovalRequestChannelAccountId } from "sunclaw/plugin-sdk/approval-native-runtime";
import type {
  ExecApprovalRequest,
  PluginApprovalRequest,
} from "sunclaw/plugin-sdk/approval-runtime";
import type { SunClawConfig } from "sunclaw/plugin-sdk/config-contracts";
import type { TelegramExecApprovalConfig } from "sunclaw/plugin-sdk/config-contracts";
...
function resolveTelegramOwnerApprovers(cfg: SunClawConfig): Array<string | number> {
