...
import { resolveAgentMaxConcurrent } from "sunclaw/plugin-sdk/model-session-runtime";
...
export function createTelegramRunnerOptions(cfg: SunClawConfig): RunOptions<unknown> {
  return {
    sink: {
