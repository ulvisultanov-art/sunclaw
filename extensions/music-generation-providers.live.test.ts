...
const providerFilter = parseCsvFilter(process.env.SUNCLAW_LIVE_MUSIC_GENERATION_PROVIDERS);
const envModelMap = parseProviderModelMap(process.env.SUNCLAW_LIVE_MUSIC_GENERATION_MODELS);
