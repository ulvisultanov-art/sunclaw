...
type MemoryToolOptions = {
  ...
  getConfig?: () => SunClawConfig | undefined;
  agentId?: string;
...
function getToolConfig(options: MemoryToolOptions): SunClawConfig | undefined {
...
function resolveMemoryToolOptions(ctx: SunClawPluginToolContext): MemoryToolOptions {
