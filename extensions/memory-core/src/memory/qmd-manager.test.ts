...
import { withMockedWindowsPlatform } from "sunclaw/plugin-sdk/test-node-mocks";
...
const MEMORY_EMBEDDING_PROVIDERS_KEY = Symbol.for("sunclaw.memoryEmbeddingProviders");
const MCPORTER_STATE_KEY = Symbol.for("sunclaw.mcporterState");
const QMD_EMBED_QUEUE_KEY = Symbol.for("sunclaw.qmdEmbedQueueTail");
...
vi.mock("sunclaw/plugin-sdk/memory-core-host-engine-foundation", async () => {
  const actual = await vi.importActual<
    typeof import("sunclaw/plugin-sdk/memory-core-host-engine-foundation")
  >("sunclaw/plugin-sdk/memory-core-host-engine-foundation");
  return {
    ...actual,
...
import type { SunClawConfig } from "sunclaw/plugin-sdk/memory-core-host-engine-foundation";
import {
  requireNodeSqlite,
