...
Nostr DM channel plugin for SunClaw using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to SunClaw. It enables your bot to:
...
# Configure sunclaw to use local relay
