...
import { normalizeSecretInputString, type SecretInput } from "sunclaw/plugin-sdk/secret-input";
...
function resolveConfiguredDefaultNostrAccountId(cfg: SunClawConfig): string | undefined {
 ...
 */
export function listNostrAccountIds(cfg: SunClawConfig): string[] {
  const nostrCfg = (cfg.channels as Record<string, unknown> | undefined)?.nostr as
    | NostrAccountConfig
    | undefined;
 ...
 */
export function resolveDefaultNostrAccountId(cfg: SunClawConfig): string {
