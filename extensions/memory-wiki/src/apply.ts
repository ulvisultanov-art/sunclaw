...
import { readFiniteNumberParam } from "sunclaw/plugin-sdk/param-readers";
...
const GENERATED_START = "<!-- sunclaw:wiki:generated:start -->";
const GENERATED_END = "<!-- sunclaw:wiki:generated:end -->";
const HUMAN_START = "<!-- sunclaw:human:start -->";
const HUMAN_END = "<!-- sunclaw:human:end -->";
