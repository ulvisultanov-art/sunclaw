...
import { mapPluginConfigIssues } from "sunclaw/plugin-sdk/extension-shared";
import { buildPluginConfigSchema, z, type SunClawPluginConfigSchema } from "../api.js";
...
export const memoryWikiConfigSchema: SunClawPluginConfigSchema = memoryWikiConfigSchemaBase;
...
export function resolveDefaultMemoryWikiVaultPath(homedir = os.homedir()): string {
  return path.join(homedir, ".sunclaw", "wiki", "main");
}
