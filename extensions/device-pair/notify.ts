...
import type { SunClawPluginService } from "sunclaw/plugin-sdk/core";
import { listDevicePairing } from "sunclaw/plugin-sdk/device-bootstrap";
...
export function createPairingNotifierService(api: SunClawPluginApi): SunClawPluginService {
...
export function registerPairingNotifierService(api: SunClawPluginApi): void {
