...
function mergeZaloAccountConfig(cfg: SunClawConfig, accountId: string): ZaloAccountConfig {
...
export function listEnabledZaloAccounts(cfg: SunClawConfig): ResolvedZaloAccount[] {
