...
} from "sunclaw/plugin-sdk/approval-reply-runtime";
import { buildPluginApprovalResolvedReplyPayload } from "sunclaw/plugin-sdk/approval-runtime";
import type {
  ExecApprovalRequest,
...
// SunClaw Matrix custom event content for capable clients; body and reactions remain fallback.
const MATRIX_APPROVAL_METADATA_KEY = "com.sunclaw.approval" as const;
