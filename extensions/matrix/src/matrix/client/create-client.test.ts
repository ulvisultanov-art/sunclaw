...
describe("createMatrixClient", () => {
  const storagePaths = {
    rootDir: "/tmp/sunclaw-matrix-create-client-test",
    storagePath: "/tmp/sunclaw-matrix-create-client-test/storage.json",
    recoveryKeyPath: "/tmp/sunclaw-matrix-create-client-test/recovery.key",
    idbSnapshotPath: "/tmp/sunclaw-matrix-create-client-test/idb.snapshot",
    metaPath: "/tmp/sunclaw-matrix-create-client-test/storage-meta.json",
    accountKey: "default",
  ...
  it("persists storage metadata by default", async () => {
    ...
    expect(MatrixClientMock).toHaveBeenCalledWith("https://matrix.example.org", "tok", {
      ...
      cryptoDatabasePrefix: "sunclaw-matrix-default-token-hash",
