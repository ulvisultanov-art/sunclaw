import { resolveConfiguredAcpBindingRecord } from "sunclaw/plugin-sdk/acp-binding-resolve-runtime";
...
import { getSessionBindingService } from "sunclaw/plugin-sdk/session-binding-runtime";
