import type { SunClawPluginApi as MatrixEntryPluginApi } from "sunclaw/plugin-sdk/channel-entry-contract";
import {
...
vi.mock("sunclaw/plugin-sdk/conversation-binding-runtime", () => ({
