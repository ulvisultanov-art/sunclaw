...
export function resolveSearxngCategories(config?: SunClawConfig): string | undefined {
  return normalizeTrimmedString(resolveSearxngWebSearchConfig(config)?.categories);
}

export function resolveSearxngLanguage(config?: SunClawConfig): string | undefined {
