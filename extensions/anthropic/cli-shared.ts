...
// steer SunClaw-managed Claude CLI runs toward a different provider,
...
function isSunClawRequestedYolo(context?: CliBackendNormalizeConfigContext): boolean {
...
export function resolveClaudePermissionMode(context?: CliBackendNormalizeConfigContext): {
  ...
  return isSunClawRequestedYolo(context)
