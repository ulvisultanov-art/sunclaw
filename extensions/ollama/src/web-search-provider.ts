...
function resolveConfiguredOllamaWebSearchApiKey(config?: SunClawConfig): string | undefined {
...
function resolveOllamaWebSearchApiKey(config?: SunClawConfig): string | undefined {
  return resolveConfiguredOllamaWebSearchApiKey(config) ?? resolveEnvOllamaWebSearchApiKey();
}

function resolveOllamaWebSearchBaseUrl(config?: SunClawConfig): string {
