...
const mocks = vi.hoisted(() => ({
  runtimeConfig: {} as SunClawConfig,
  runtimeSourceConfig: null as SunClawConfig | null,
...
vi.mock("../browser/chrome.js", () => ({
  ...
  launchSunClawChrome: vi.fn(async () => {
    throw new Error("launch should not be needed for status");
  }),
  resolveSunClawUserDataDir: vi.fn(() => "/tmp/sunclaw-browser"),
