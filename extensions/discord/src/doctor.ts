...
import { collectProviderDangerousNameMatchingScopes } from "sunclaw/plugin-sdk/runtime-doctor";
...
export function scanDiscordNumericIdEntries(cfg: SunClawConfig): DiscordNumericIdHit[] {
...
export function maybeRepairDiscordNumericIds(
  cfg: SunClawConfig,
  doctorFixCommand: string,
): { config: SunClawConfig; changes: string[]; warnings?: string[] } {
...
function collectDiscordMutableAllowlistWarnings(cfg: SunClawConfig): string[] {
