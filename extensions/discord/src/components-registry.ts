...
const DISCORD_COMPONENT_ENTRIES_KEY = Symbol.for("sunclaw.discord.componentEntries");
const DISCORD_MODAL_ENTRIES_KEY = Symbol.for("sunclaw.discord.modalEntries");
