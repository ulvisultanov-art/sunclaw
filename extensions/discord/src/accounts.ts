...
import type { DiscordAccountConfig, DiscordActionConfig, SunClawConfig } from "./runtime-api.js";
...
export function listEnabledDiscordAccounts(cfg: SunClawConfig): ResolvedDiscordAccount[] {
