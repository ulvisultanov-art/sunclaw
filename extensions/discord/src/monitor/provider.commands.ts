...
import { danger, warn, type RuntimeEnv } from "sunclaw/plugin-sdk/runtime-env";
import {
...
export type GetPluginCommandSpecs =
  typeof import("sunclaw/plugin-sdk/plugin-runtime").getPluginCommandSpecs;

let pluginRuntimePromise: Promise<typeof import("sunclaw/plugin-sdk/plugin-runtime")> | undefined;

async function loadPluginRuntime() {
  const promise = pluginRuntimePromise ?? import("sunclaw/plugin-sdk/plugin-runtime");
