...
vi.mock("sunclaw/plugin-sdk/approval-gateway-runtime", async (importOriginal) => {
  const actual =
    await importOriginal<typeof import("sunclaw/plugin-sdk/approval-gateway-runtime")>();
  return {
    ...actual,
