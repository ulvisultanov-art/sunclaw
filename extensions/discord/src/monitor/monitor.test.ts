...
import { buildPluginBindingApprovalCustomId } from "sunclaw/plugin-sdk/conversation-runtime";
...
describe("discord component interactions", () => {
  ...
  beforeEach(() => {
    ...
    resolveStorePathMock.mockClear().mockReturnValue("/tmp/sunclaw-sessions-test.json");
