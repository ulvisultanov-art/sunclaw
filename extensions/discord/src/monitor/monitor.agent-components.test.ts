...
import { peekSystemEvents, resetSystemEventsForTest } from "sunclaw/plugin-sdk/test-fixtures";
...
describe("agent components", () => {
  ...
  const createCfg = (): SunClawConfig => ({}) as SunClawConfig;
  ...
  it("sends pairing reply when DM sender is not allowlisted", async () => {
    ...
    expect(pairingText).toContain(`sunclaw pairing approve discord ${code}`);
