...
import { resolveAckReaction, resolveHumanDelayConfig } from "sunclaw/plugin-sdk/agent-runtime";
import {
...
import { getAgentScopedMediaLocalRoots } from "sunclaw/plugin-sdk/media-runtime";
import { resolveChunkMode } from "sunclaw/plugin-sdk/reply-chunking";
...
import type { ReplyDispatchKind, ReplyPayload } from "sunclaw/plugin-sdk/reply-runtime";
...
let replyRuntimePromise: Promise<typeof import("sunclaw/plugin-sdk/reply-runtime")> | undefined;

async function loadReplyRuntime() {
  replyRuntimePromise ??= import("sunclaw/plugin-sdk/reply-runtime");
