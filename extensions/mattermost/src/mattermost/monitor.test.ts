import { createClaimableDedupe } from "sunclaw/plugin-sdk/persistent-dedupe";
...
function evaluateMentionGateForMessage(params: { cfg: SunClawConfig; threadRootId?: string }) {
...
describe("shouldUpdateMattermostDraftToolProgress", () => {
  type MattermostConfig = NonNullable<NonNullable<SunClawConfig["channels"]>["mattermost"]>;
