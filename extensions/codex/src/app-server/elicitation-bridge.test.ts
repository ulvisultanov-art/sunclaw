...
describe("Codex app-server elicitation bridge", () => {
  ...
  it("accepts current Codex MCP approval elicitations with an empty form schema", async () => {
    ...
    expect(approvalRequest.description).toContain("Repository: sunclaw/sunclaw");
  });
          ...
          tool_params_display: [
            {
              ...
              value: "\u001b]8;;https://evil.example\u001b\\sunclaw/sunclaw\u001b]8;;\u001b\\",
            },
          ],
        },
        requestedSchema: {
  ...
  it("falls back to stable names when display labels sanitize to empty", async () => {
    ...
    expect(approvalRequest.description).toContain("- repo: sunclaw/sunclaw");
