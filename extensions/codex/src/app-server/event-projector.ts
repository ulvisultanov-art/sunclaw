...
import { generatedImageAssetFromBase64 } from "sunclaw/plugin-sdk/image-generation";
import type { AssistantMessage, Usage } from "sunclaw/plugin-sdk/llm";
...
const MISSING_TOOL_RESULT_ERROR =
  "SunClaw recorded a native Codex tool.call without a matching tool.result before the turn completed.";
const GENERATED_IMAGE_MEDIA_SUBDIR = "tool-image-generation";
const BYTES_PER_MB = 1024 * 1024;
// Match SunClaw's default image media cap for generated image tool outputs.
...
export class CodexAppServerEventProjector {
  ...
  buildResult(
    ...
    // context for SunClaw history, search, and future harness switching.
    if (reasoningText) {
...
function shouldSuppressChannelProgressForItem(item: CodexThreadItem): boolean {
  ...
  // Dynamic SunClaw tool requests are emitted at the item/tool/call request
