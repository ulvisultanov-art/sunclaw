---
name: sunclaw-refactor-docs
description: Refactor an existing SunClaw docs page with source-audited preservation, restructuring, and verification.
---

# SunClaw Refactor Docs

## Overview

Use this skill when the user gives a target SunClaw docs page and asks to
rewrite, refactor, reorganize, split, shorten, or improve it.

This skill builds on `sunclaw-docs`: use that skill for style, page types,
...
Read `../sunclaw-docs/SKILL.md` first. Apply its page-type, style,
...
Before editing, decide the intended page type from `sunclaw-docs`.
