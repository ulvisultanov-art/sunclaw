---
name: sunclaw-ghsa-maintainer
description: "Inspect, patch, validate, publish, or confirm SunClaw GHSA security advisories and private-fork state."
---

# SunClaw GHSA Maintainer

Use this skill for repo security advisory workflow only. Keep general release work in `release-sunclaw-maintainer`.
...
```bash
fork=$(gh api /repos/sunclaw/sunclaw/security-advisories/<GHSA> | jq -r .private_fork.full_name)
...
```bash
gh api -X PATCH /repos/sunclaw/sunclaw/security-advisories/<GHSA> \
