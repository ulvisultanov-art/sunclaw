# SunClaw Documentation Overlay

Use this reference only for SunClaw docs work. It layers SunClaw-specific page
...
- Topic page: explain a major SunClaw entity or surface end to end.
...
- Governance file: keep agent/contributor policy concrete, scoped, and aligned
  with current SunClaw repo behavior.
