...
- For SunClaw docs work, choose a page type from `references/sunclaw.md` before drafting.
- Keep task-critical SunClaw configuration inline; link exhaustive defaults, enums, schemas, generated references, and rare debugging workflows.
...
- For SunClaw docs work, apply the validation checklist in `references/sunclaw.md`.
