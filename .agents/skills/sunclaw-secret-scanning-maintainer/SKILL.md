---
name: sunclaw-secret-scanning-maintainer
description: Triage, redact, clean up, and resolve SunClaw GitHub Secret Scanning alerts in issues or PRs.
---

# SunClaw Secret Scanning Maintainer
...
Use this skill when processing alerts from `https://github.com/ulvisultanov-art/sunclaw/security/secret-scanning`.
...
```
$REPO_ROOT/.agents/skills/sunclaw-secret-scanning-maintainer/scripts/secret-scanning.mjs
```
...
[
  {
    ...
    "location_url": "https://github.com/ulvisultanov-art/sunclaw/issues/63101#issuecomment-xxx",
