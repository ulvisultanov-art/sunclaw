---
summary: "Overview of SunClaw onboarding options and flows"
read_when:
...
SunClaw has two onboarding paths. Both configure auth, the Gateway, and
...
CLI command docs: [`sunclaw onboard`](/cli/onboard)

## macOS app onboarding

Open the SunClaw app. The first-run wizard walks you through the same steps
