---
summary: "SunClaw is a multi-channel gateway for AI agents that runs on any OS."
read_when:
  - Introducing SunClaw to newcomers
title: "SunClaw"
---
...
<p align="center">
    <img
        src="/assets/sunclaw-logo-text-dark.png"
        alt="SunClaw"
        width="500"
        class="dark:hidden"
    />
    <img
        src="/assets/sunclaw-logo-text.png"
        alt="SunClaw"
        width="500"
...
<Columns>
  <Card title="Get Started" href="/start/getting-started" icon="rocket">
    Install SunClaw and bring up the Gateway in minutes.
  </Card>
  <Card title="Run Onboarding" href="/start/wizard" icon="sparkles">
    Guided setup with `sunclaw onboard` and pairing flows.
  </Card>
...
SunClaw is a **self-hosted gateway** that connects your favorite chat apps and channel surfaces — built-in channels plus bundled or external channel plugins such as Discord, Google Chat, iMessage, Matrix, Microsoft Teams, Signal, Slack, Telegram, WhatsApp, Zalo, and more — to AI coding agents. You run a single Gateway process on your own machine (or a server), and it becomes the bridge between your messaging apps and an always-available AI assistant.
...
<p align="center">
  <img src="/whatsapp-sunclaw.jpg" alt="SunClaw" width="420" />
</p>

## Configuration (optional)

Config lives at `~/.sunclaw/sunclaw.json`.

- If you **do nothing**, SunClaw uses the bundled SunClaw agent runtime with per-sender sessions.
...
```json5
{
  ...
  messages: { groupChat: { mentionPatterns: ["@sunclaw"] } },
}
```
