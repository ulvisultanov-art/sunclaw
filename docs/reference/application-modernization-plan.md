...
read_when:
  - Planning a broad SunClaw application modernization pass
...
modernization task. If adopting this guidance as a repo-local SunClaw skill,
create `.agents/skills/sunclaw-frontend/SKILL.md` first, keep the frontmatter
