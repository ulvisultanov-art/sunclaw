---
summary: "Adds Google, Google Gemini CLI, Google Vertex model provider support to SunClaw."
read_when:
...
Adds Google, Google Gemini CLI, Google Vertex model provider support to SunClaw.

## Distribution

- Package: `@sunclaw/google-plugin`
