---
summary: "CLI reference for `sunclaw voicecall` (voice-call plugin command surface)"
read_when:
...
sunclaw voicecall smoke    [-t <phone>] [--message <text>] [--mode <m>] [--yes] [--json]
sunclaw voicecall call     -m <text> [-t <phone>] [--mode <m>]
sunclaw voicecall start    --to <phone> [--message <text>] [--mode <m>]
sunclaw voicecall continue --call-id <id> --message <text>
sunclaw voicecall speak    --call-id <id> --message <text>
sunclaw voicecall dtmf     --call-id <id> --digits <digits>
sunclaw voicecall end      --call-id <id>
sunclaw voicecall status   [--call-id <id>] [--json]
sunclaw voicecall tail     [--file <path>] [--since <n>] [--poll <ms>]
sunclaw voicecall latency  [--file <path>] [--last <n>]
sunclaw voicecall expose   [--mode <m>] [--path <p>] [--port <port>] [--serve-path <p>]
```
...
sunclaw voicecall smoke --to "+15555550123"        # dry run
sunclaw voicecall smoke --to "+15555550123" --yes  # live notify call
```
...
```bash
sunclaw voicecall call --to "+15555550123" --message "Hello"
sunclaw voicecall call -m "Heads up" --mode notify
```
...
```bash
sunclaw voicecall status
sunclaw voicecall status --json
...
```bash
sunclaw voicecall expose --mode serve
sunclaw voicecall expose --mode funnel
sunclaw voicecall expose --mode off
```
