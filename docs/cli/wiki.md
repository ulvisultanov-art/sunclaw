---
summary: "CLI reference for `sunclaw wiki` (memory-wiki vault status, search, compile, lint, apply, bridge, and Obsidian helpers)"
read_when:
  - You want to use the memory-wiki CLI
  - You are documenting or changing `sunclaw wiki`
title: "Wiki"
---
...
Use `sunclaw wiki` when you want a compiled knowledge vault with:
...
sunclaw wiki doctor
sunclaw wiki init
sunclaw wiki ingest ./notes/alpha.md
sunclaw wiki compile
sunclaw wiki lint
sunclaw wiki search "alpha"
sunclaw wiki search "who should I ask about Teams?" --mode route-question
sunclaw wiki get entity.alpha --from 1 --lines 80

sunclaw wiki apply synthesis "Alpha Summary" \
  --body "Short synthesis body" \
  --source-id source.alpha

sunclaw wiki apply metadata entity.alpha \
  --source-id source.alpha \
  --status review \
  --question "Still active?"

sunclaw wiki bridge import
sunclaw wiki unsafe-local import

sunclaw wiki obsidian status
sunclaw wiki obsidian search "alpha"
sunclaw wiki obsidian open syntheses/alpha-summary.md
sunclaw wiki obsidian command workspace:quick-switcher
sunclaw wiki obsidian daily
```
...
- `.sunclaw-wiki/cache/agent-digest.json`
- `.sunclaw-wiki/cache/claims.jsonl`
...
For one broad shared recall pass, prefer `sunclaw memory search` when the
...
```bash
sunclaw wiki search "bgroux" --mode find-person
sunclaw wiki search "who knows Teams rollout?" --mode route-question
sunclaw wiki search "maintainer-whois" --mode source-evidence
sunclaw wiki search "strong route Teams" --mode raw-claim --json
```
...
```bash
sunclaw wiki get entity.alpha
sunclaw wiki get syntheses/alpha-summary.md --from 1 --lines 80
```
...
`sunclaw wiki` behavior is shaped by:
