---
summary: "CLI reference for `sunclaw system` (system events, heartbeat, presence)"
read_when:
...
sunclaw system event --text "Check for urgent follow-ups" --url ws://127.0.0.1:18789 --token "$SUNCLAW_GATEWAY_TOKEN"
sunclaw system heartbeat enable
sunclaw system heartbeat last
sunclaw system presence
```
