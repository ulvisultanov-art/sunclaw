...
const SENDER_METADATA_BLOCK =
  'Sender (untrusted metadata):\n```json\n{"label":"sunclaw-control-ui","id":"sunclaw-control-ui"}\n```';
      ...
      messages: [
        {
          ...
          senderLabel: "sunclaw-control-ui",
          timestamp: 1,
        },
      ],
    });
      ...
      toolMessages: [
        {
          ...
          content: JSON.stringify({
            ...
            view: {
              backend: "canvas",
              id: "cv_nearest_turn",
              url: "/__sunclaw__/canvas/documents/cv_nearest_turn/index.html",
      ...
      toolMessages: [
        {
          ...
          content: JSON.stringify({
            ...
            view: {
              backend: "canvas",
              id: "cv_empty_anchor",
              url: "/__sunclaw__/canvas/documents/cv_empty_anchor/index.html",
          ...
          content: JSON.stringify({
            selected_item: {
              ...
              view: {
                ...
                url: "/__sunclaw__/canvas/documents/cv_generic_inline/index.html",
            ...
            },
            {
              ...
              text: JSON.stringify({
                ...
                view: {
                  ...
                  url: "/__sunclaw__/canvas/documents/cv_streamed_artifact/index.html",
                  title: "Streamed demo",
                  preferred_height: 320,
                },
                presentation: {
...
function createAssistantCanvasBlock(params: { suffix: string }) {
  ...
  return {
    ...
    preview: {
      ...
      viewId,
      title: "Inline demo",
      url: `/__sunclaw__/canvas/documents/${viewId}/index.html`,
      preferredHeight: 360,
    },
  };
}
