...
function buildFeedback(params: {
  ...
  const docsHref = params.docsHref ?? "https://docs.sunclaw.complex.az/web/dashboard";
  return {
    kind: params.kind,
...
export function resolveLoginFailureFeedback(
  ...
  if (pairing) {
    return buildFeedback({
      ...
      rawError,
      docsHref: "https://docs.sunclaw.complex.az/web/control-ui#device-pairing-first-connection",
      titleKey:
  ...
  if (shouldShowInsecureContextHint(false, rawError, lastErrorCode)) {
    return buildFeedback({
      ...
      rawError,
      docsHref: "https://docs.sunclaw.complex.az/web/control-ui#insecure-http",
    ...
    <div class="login-gate">
      <div class="login-gate__card">
        <div class="login-gate__header">
          <img class="login-gate__logo" src=${faviconSrc} alt="SunClaw" />
          <div class="login-gate__title">SunClaw</div>
          ...
          <label class="field">
            ...
            <div class="login-gate__secret-row">
              <input
                ...
                placeholder="SUNCLAW_GATEWAY_TOKEN (${t("login.passwordPlaceholder")})"
