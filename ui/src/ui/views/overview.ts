...
export function renderOverview(props: OverviewProps) {
      ...
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          ${pairingState.requestId
            ? html`<span class="mono">sunclaw devices approve ${pairingState.requestId}</span
                ><br />`
            : nothing}
          <span class="mono">sunclaw devices list</span>
        </div>
        <div style="margin-top: 6px; font-size: 12px;">${t("overview.pairing.mobileHint")}</div>
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.sunclaw.complex.az/web/control-ui#device-pairing-first-connection"
  ...
  const authHint = (() => {
    ...
    if (authHintKind === "required") {
      return html`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">sunclaw dashboard --no-open</span> → tokenized URL<br />
            <span class="mono">sunclaw doctor --generate-gateway-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
              href="https://docs.sunclaw.complex.az/web/dashboard"
              target=${EXTERNAL_LINK_TARGET}
              rel=${buildExternalLinkRel()}
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ${t("overview.auth.failed", { command: "sunclaw dashboard --no-open" })}
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.sunclaw.complex.az/web/dashboard"
    ...
    return html`
      <div class="muted" style="margin-top: 8px">
        ...
        <div style="margin-top: 6px">
          <a
            class="session-link"
            href="https://docs.sunclaw.complex.az/gateway/tailscale"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
          ...
          <a
            class="session-link"
            href="https://docs.sunclaw.complex.az/web/control-ui#insecure-http"
            target=${EXTERNAL_LINK_TARGET}
            rel=${buildExternalLinkRel()}
                ...
                <label class="field">
                  ...
                  <div style="display: flex; align-items: center; gap: 8px; min-width: 0;">
                    <input
                      ...
                      placeholder="SUNCLAW_GATEWAY_TOKEN"
                    />
                    <button
                      type="button"
                ...
                <ol class="login-gate__steps">
                  ...
                  <li>
                    ${t("overview.connection.step4")}<code
                      >sunclaw doctor --generate-gateway-token</code
                    >
                  </li>
                </ol>
