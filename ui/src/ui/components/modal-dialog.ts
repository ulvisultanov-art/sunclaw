...
export class SunClawModalDialog extends LitElement {
  @property() label = "";
  ...
  override render() {
    const labelId = this.label ? "sunclaw-modal-dialog-label" : "";
    const descriptionId = this.description ? "sunclaw-modal-dialog-description" : "";
    return html`
      <dialog
        role="dialog"
        aria-modal="true"
...
if (!customElements.get("sunclaw-modal-dialog")) {
  customElements.define("sunclaw-modal-dialog", SunClawModalDialog);
}

declare global {
  interface HTMLElementTagNameMap {
    "sunclaw-modal-dialog": SunClawModalDialog;
  }
}
