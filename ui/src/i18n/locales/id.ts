...
export const id: TranslationMap = {
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Di seluler? Salin URL lengkap (termasuk #token=...) dari sunclaw dashboard --no-open di desktop Anda.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc: "{providers} — autentikasi ulang dengan sunclaw models auth",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Tempel token dari sunclaw dashboard --no-open atau masukkan kata sandi yang dikonfigurasi.",
        stepGenerate:
          "Jika belum ada token yang dikonfigurasi, jalankan sunclaw doctor --generate-gateway-token di host Gateway.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Jalankan sunclaw dashboard --no-open lalu buka URL baru atau tempel tokennya.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Jalankan sunclaw devices list di host Gateway.",
        stepApproveId: "Setujui permintaan ini: sunclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Buka kembali dashboard yang disajikan dengan sunclaw dashboard agar UI dan Gateway berasal dari instalasi yang sama.",
        stepDevUi:
          "Jika menggunakan pnpm ui:dev, bangun ulang atau mulai ulang UI dev terhadap checkout saat ini.",
        stepRestart:
          "Mulai ulang Gateway setelah memperbarui SunClaw agar menyajikan protokol saat ini.",
      },
      network: {
        ...
        stepGateway: "Pastikan Gateway berjalan dengan sunclaw status atau sunclaw gateway run.",
        stepUrl:
          "Periksa URL WebSocket dan gunakan wss:// saat Gateway berada di belakang HTTPS/Tailscale Serve.",
        stepDashboard:
          "Buka kembali dashboard dengan sunclaw dashboard --no-open untuk menyalin ulang URL dan detail auth saat ini.",
      },
    },
  },
  chat: {
