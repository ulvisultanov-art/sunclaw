...
export const de: TranslationMap = {
  ...
  subtitles: {
    ...
    config: "~/.sunclaw/sunclaw.json sicher bearbeiten.",
  ...
  overview: {
    ...
    pairing: {
      ...
      mobileHint:
        "Auf dem Mobilgerät? Kopieren Sie die vollständige URL (einschließlich #token=...) von sunclaw dashboard --no-open auf Ihrem Desktop.",
    ...
    cards: {
      ...
      modelAuthAttentionExpiredDesc:
        "{providers} — mit sunclaw models auth erneut authentifizieren",
  ...
  login: {
    ...
    failure: {
      ...
      authRequired: {
        ...
        stepPaste:
          "Füge das Token aus sunclaw dashboard --no-open ein oder gib das konfigurierte Passwort ein.",
        stepGenerate:
          "Wenn kein Token konfiguriert ist, führe sunclaw doctor --generate-gateway-token auf dem Gateway-Host aus.",
      ...
      authFailed: {
        ...
        stepDashboard:
          "Führe sunclaw dashboard --no-open aus und öffne die frische URL oder füge ihr Token ein.",
        stepReplace:
      ...
      pairing: {
        ...
        stepList: "Führe sunclaw devices list auf dem Gateway-Host aus.",
        stepApproveId: "Genehmige diese Anfrage: sunclaw devices approve {requestId}.",
      ...
      protocol: {
        ...
        stepDashboard:
          "Öffne das bereitgestellte Dashboard mit sunclaw dashboard erneut, damit UI und Gateway aus derselben Installation stammen.",
        stepDevUi:
          "Wenn du pnpm ui:dev verwendest, baue oder starte die Dev-UI gegen den aktuellen Checkout neu.",
        stepRestart:
          "Starte das Gateway nach dem Aktualisieren von SunClaw neu, damit es das aktuelle Protokoll bereitstellt.",
      },
      network: {
        ...
        stepGateway:
          "Bestätige mit sunclaw status oder sunclaw gateway run, dass das Gateway läuft.",
        stepUrl:
          "Prüfe die WebSocket-URL und verwende wss://, wenn das Gateway hinter HTTPS/Tailscale Serve liegt.",
        stepDashboard:
          "Öffne das Dashboard mit sunclaw dashboard --no-open erneut, um die aktuelle URL und Auth-Details zu kopieren.",
      },
    },
  },
  chat: {
