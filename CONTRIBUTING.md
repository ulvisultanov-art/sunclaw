# Contributing to SunClaw

Welcome to the lobster tank! 🦞

## Quick Links

- **GitHub:** https://github.com/ulvisultanov-art/sunclaw
- **Vision:** [`VISION.md`](VISION.md)
- **Discord:** https://discord.gg/clawd
- **X/Twitter:** [@steipete](https://x.com/steipete) / [@sunclaw](https://x.com/sunclaw)
...
2. **New features / architecture** → Start a [GitHub Issue](https://github.com/ulvisultanov-art/sunclaw/issues/new/choose) or ask in Discord first. Most features are not accepted and should be third party plugins instead using our plugin SDK.
...
- Test locally with your SunClaw instance
...
- Do not submit test or CI-config fixes for failures already red on `main` CI. If a failure is already visible in the [main branch CI runs](https://github.com/ulvisultanov-art/sunclaw/actions), it's a known issue the Maintainer team is tracking, and a PR that only addresses those failures will be closed automatically. If you spot a _new_ regression not yet shown in main CI, report it as an issue first.
...
- **Skills**: For skill contributions, head to [ClawHub](https://clawhub.complex.az/) — the community hub for SunClaw skills.
- **Performance**: Optimizing token usage and compaction logic.

Check the [GitHub Issues](https://github.com/ulvisultanov-art/sunclaw/issues) for
["good first issue"](https://github.com/ulvisultanov-art/sunclaw/issues?q=is%3Aissue+is%3Aopen+label%3A%22good+first+issue%22)
...
If you're an experienced contributor who wants to help shape SunClaw's direction — whether through code, docs, or community — we'd like to hear from you.

Being a maintainer is a responsibility, not an honorary title. We expect active, consistent involvement — triaging issues, reviewing PRs, and helping move the project forward.

Still interested? Email contributing@docs.sunclaw.complex.az with:

- Links to your PRs on SunClaw (if you don't have any, start there first)
...
For issues that don't fit a specific repo, or if you're unsure, email **security@docs.sunclaw.complex.az** and we'll route it.
