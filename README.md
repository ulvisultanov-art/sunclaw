# 🦞 SunClaw — Personal AI Assistant

<p align="center">
    <picture>
        <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/sunclaw/sunclaw/main/docs/assets/sunclaw-logo-text-dark.svg">
        <img src="https://raw.githubusercontent.com/sunclaw/sunclaw/main/docs/assets/sunclaw-logo-text.svg" alt="SunClaw" width="500">
    </picture>
</p>
...
<p align="center">
  <a href="https://github.com/ulvisultanov-art/sunclaw/actions/workflows/ci.yml?branch=main"><img src="https://img.shields.io/github/actions/workflow/status/sunclaw/sunclaw/ci.yml?branch=main&style=for-the-badge" alt="CI status"></a>
  <a href="https://github.com/ulvisultanov-art/sunclaw/releases"><img src="https://img.shields.io/github/v/release/sunclaw/sunclaw?include_prereleases&style=for-the-badge" alt="GitHub release"></a>
  <a href="https://discord.gg/clawd"><img src="https://img.shields.io/discord/1456350064065904867?label=Discord&logo=discord&logoColor=white&color=5865F2&style=for-the-badge" alt="Discord"></a>
  <a href="LICENSE"><img src="https://img.shields.io/badge/License-MIT-blue.svg?style=for-the-badge" alt="MIT License"></a>
</p>

**SunClaw** is a _personal AI assistant_ you run on your own devices.
...
[Website](https://docs.sunclaw.complex.az) · [Docs](https://docs.sunclaw.complex.az) · [Vision](VISION.md) · [Third-party notices](THIRD_PARTY_NOTICES.md) · [DeepWiki](https://deepwiki.com/sunclaw/sunclaw) · [Getting Started](https://docs.sunclaw.complex.az/start/getting-started) · [Updating](https://docs.sunclaw.complex.az/install/updating) · [Showcase](https://docs.sunclaw.complex.az/start/showcase) · [FAQ](https://docs.sunclaw.complex.az/help/faq) · [Onboarding](https://docs.sunclaw.complex.az/start/wizard) · [Nix](https://github.com/sunclaw/nix-sunclaw) · [Docker](https://docs.sunclaw.complex.az/install/docker) · [Discord](https://discord.gg/clawd)

New install? Start here: [Getting started](https://docs.sunclaw.complex.az/start/getting-started)

Preferred setup: run `sunclaw onboard` in your terminal.
SunClaw Onboard guides you step by step through setting up the gateway, workspace, channels, and skills. It is the recommended CLI setup path and works on **macOS, Linux, and Windows (via WSL2; strongly recommended)**.
  ...
  <tr>
    <td align="center" width="16.66%">
      <a href="https://openai.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/sunclaw/sunclaw/main/docs/assets/sponsors/openai-light.svg">
          <img src="https://raw.githubusercontent.com/sunclaw/sunclaw/main/docs/assets/sponsors/openai.svg" alt="OpenAI" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://github.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/sunclaw/sunclaw/main/docs/assets/sponsors/github-light.svg">
          <img src="https://raw.githubusercontent.com/sunclaw/sunclaw/main/docs/assets/sponsors/github.svg" alt="GitHub" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.nvidia.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/sunclaw/sunclaw/main/docs/assets/sponsors/nvidia.svg">
          <img src="https://raw.githubusercontent.com/sunclaw/sunclaw/main/docs/assets/sponsors/nvidia-dark.svg" alt="NVIDIA" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://vercel.com/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/sunclaw/sunclaw/main/docs/assets/sponsors/vercel-light.svg">
          <img src="https://raw.githubusercontent.com/sunclaw/sunclaw/main/docs/assets/sponsors/vercel.svg" alt="Vercel" height="24">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://blacksmith.sh/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/sunclaw/sunclaw/main/docs/assets/sponsors/blacksmith-light.svg">
          <img src="https://raw.githubusercontent.com/sunclaw/sunclaw/main/docs/assets/sponsors/blacksmith.svg" alt="Blacksmith" height="28">
        </picture>
      </a>
    </td>
    <td align="center" width="16.66%">
      <a href="https://www.convex.dev/">
        <picture>
          <source media="(prefers-color-scheme: light)" srcset="https://raw.githubusercontent.com/sunclaw/sunclaw/main/docs/assets/sponsors/convex-light.svg">
          <img src="https://raw.githubusercontent.com/sunclaw/sunclaw/main/docs/assets/sponsors/convex.svg" alt="Convex" height="24">
        </picture>
      </a>
    </td>
  </tr>
...
Model note: while many providers and models are supported, prefer a current flagship model from the provider you trust and already use. See [Onboarding](https://docs.sunclaw.complex.az/start/wizard).
...
# or: pnpm add -g sunclaw@latest

sunclaw onboard --install-daemon
```

SunClaw Onboard installs the Gateway daemon (launchd/systemd user service) so it stays running.

## Quick start (TL;DR)

Runtime: **Node 24 (recommended) or Node 22.19+**.

Full beginner guide (auth, pairing, channels): [Getting started](https://docs.sunclaw.complex.az/start/getting-started)
...
```bash
# Send a message
sunclaw message send --target +1234567890 --message "Hello from SunClaw"
...
sunclaw agent --message "Ship checklist" --thinking high
```

Upgrading? [Updating guide](https://docs.sunclaw.complex.az/install/updating) (and run `sunclaw doctor`).

Models config + CLI: [Models](https://docs.sunclaw.complex.az/concepts/models). Auth profile rotation + fallbacks: [Model failover](https://docs.sunclaw.complex.az/concepts/model-failover).

## Security defaults (DM access)

SunClaw connects to real messaging surfaces. Treat inbound DMs as **untrusted input**.

Full security guide: [Security](https://docs.sunclaw.complex.az/gateway/security).
Before remote exposure, use the [Gateway exposure runbook](https://docs.sunclaw.complex.az/gateway/security/exposure-runbook).

Default behavior on Telegram/WhatsApp/Signal/iMessage/Microsoft Teams/Discord/Google Chat/Slack:

- **DM pairing** (`dmPolicy="pairing"` / `channels.discord.dmPolicy="pairing"` / `channels.slack.dmPolicy="pairing"`; legacy: `channels.discord.dm.policy`, `channels.slack.dm.policy`): unknown senders receive a short pairing code and the bot does not process their message.
- Approve with: `sunclaw pairing approve <channel> <code>` (then the sender is added to a local allowlist store).
- Public inbound DMs require an explicit opt-in: set `dmPolicy="open"` and include `"*"` in the channel allowlist (`allowFrom` / `channels.discord.allowFrom` / `channels.slack.allowFrom`; legacy: `channels.discord.dm.allowFrom`, `channels.slack.dm.allowFrom`).

Run `sunclaw doctor` to surface risky/misconfigured DM policies.

## Highlights

- **[Local-first Gateway](https://docs.sunclaw.complex.az/gateway)** — single control plane for sessions, channels, tools, and events.
- **[Multi-channel inbox](https://docs.sunclaw.complex.az/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, iMessage, IRC, Microsoft Teams, Matrix, Feishu, LINE, Mattermost, Nextcloud Talk, Nostr, Synology Chat, Tlon, Twitch, Zalo, Zalo Personal, WeChat, QQ, WebChat, macOS, iOS/Android.
- **[Multi-agent routing](https://docs.sunclaw.complex.az/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Voice Wake](https://docs.sunclaw.complex.az/nodes/voicewake) + [Talk Mode](https://docs.sunclaw.complex.az/nodes/talk)** — wake words on macOS/iOS and continuous voice on Android (ElevenLabs + system TTS fallback).
- **[Live Canvas](https://docs.sunclaw.complex.az/platforms/mac/canvas)** — agent-driven visual workspace with [A2UI](https://docs.sunclaw.complex.az/platforms/mac/canvas#canvas-a2ui).
- **[First-class tools](https://docs.sunclaw.complex.az/tools)** — browser, canvas, nodes, cron, sessions, and Discord/Slack actions.
- **[Companion apps](https://docs.sunclaw.complex.az/platforms/macos)** — macOS menu bar app + iOS/Android [nodes](https://docs.sunclaw.complex.az/nodes).
- **[Onboarding](https://docs.sunclaw.complex.az/start/wizard) + [skills](https://docs.sunclaw.complex.az/tools/skills)** — onboarding-driven setup with bundled/managed/workspace skills.
...
- Before exposing anything remotely, read [Security](https://docs.sunclaw.complex.az/gateway/security), [Gateway exposure runbook](https://docs.sunclaw.complex.az/gateway/security/exposure-runbook), [Sandboxing](https://docs.sunclaw.complex.az/gateway/sandboxing), and [Configuration](https://docs.sunclaw.complex.az/gateway/configuration).
...
- Skills registry: [ClawHub](https://clawhub.complex.az)
- Architecture overview: [Architecture](https://docs.sunclaw.complex.az/concepts/architecture)

## Docs by goal

- New here: [Getting started](https://docs.sunclaw.complex.az/start/getting-started), [Onboarding](https://docs.sunclaw.complex.az/start/wizard), [Updating](https://docs.sunclaw.complex.az/install/updating)
- Channel setup: [Channels index](https://docs.sunclaw.complex.az/channels), [WhatsApp](https://docs.sunclaw.complex.az/channels/whatsapp), [Telegram](https://docs.sunclaw.complex.az/channels/telegram), [Discord](https://docs.sunclaw.complex.az/channels/discord), [Slack](https://docs.sunclaw.complex.az/channels/slack)
- Apps + nodes: [macOS](https://docs.sunclaw.complex.az/platforms/macos), [iOS](https://docs.sunclaw.complex.az/platforms/ios), [Android](https://docs.sunclaw.complex.az/platforms/android), [Nodes](https://docs.sunclaw.complex.az/nodes)
- Config + security: [Configuration](https://docs.sunclaw.complex.az/gateway/configuration), [Security](https://docs.sunclaw.complex.az/gateway/security), [Exposure runbook](https://docs.sunclaw.complex.az/gateway/security/exposure-runbook), [Sandboxing](https://docs.sunclaw.complex.az/gateway/sandboxing)
- Remote + web: [Gateway](https://docs.sunclaw.complex.az/gateway), [Remote access](https://docs.sunclaw.complex.az/gateway/remote), [Tailscale](https://docs.sunclaw.complex.az/gateway/tailscale), [Web surfaces](https://docs.sunclaw.complex.az/web)
- Tools + automation: [Tools](https://docs.sunclaw.complex.az/tools), [Skills](https://docs.sunclaw.complex.az/tools/skills), [Cron jobs](https://docs.sunclaw.complex.az/automation/cron-jobs), [Webhooks](https://docs.sunclaw.complex.az/automation/webhook), [Gmail Pub/Sub](https://docs.sunclaw.complex.az/automation/gmail-pubsub)
- Internals: [Architecture](https://docs.sunclaw.complex.az/concepts/architecture), [Agent](https://docs.sunclaw.complex.az/concepts/agent), [Session model](https://docs.sunclaw.complex.az/concepts/session), [Gateway protocol](https://docs.sunclaw.complex.az/reference/rpc)
- Troubleshooting: [Channel troubleshooting](https://docs.sunclaw.complex.az/channels/troubleshooting), [Logging](https://docs.sunclaw.complex.az/logging), [Docs home](https://docs.sunclaw.complex.az)
...
Note: signed builds required for macOS permissions to stick across rebuilds (see [macOS Permissions](https://docs.sunclaw.complex.az/platforms/mac/permissions)).

### iOS node (optional)

- Pairs as a node over the Gateway WebSocket (device pairing).
- Voice trigger forwarding + Canvas surface.
- Controlled via `sunclaw nodes …`.

Runbook: [iOS connect](https://docs.sunclaw.complex.az/platforms/ios).

### Android node (optional)

- Pairs as a WS node via device pairing (`sunclaw devices ...`).
- Exposes Connect/Chat/Voice tabs plus Canvas, Camera, Screen capture, and Android device command families.
- Runbook: [Android connect](https://docs.sunclaw.complex.az/platforms/android).
...
`pnpm sunclaw setup` writes the local config/workspace needed for `pnpm gateway:watch`. It is safe to re-run, but you normally only need it on first setup or after resetting local state. `pnpm gateway:watch` does not rebuild `dist/control-ui`, so rerun `pnpm ui:build` after `ui/` changes or use `pnpm ui:dev` when iterating on the Control UI. If you want this checkout to run onboarding directly, use `pnpm sunclaw onboard --install-daemon`.

Note: `pnpm sunclaw ...` runs TypeScript directly (via `tsx`). `pnpm build` produces `dist/` for running via Node / the packaged `sunclaw` binary, while `pnpm gateway:watch` rebuilds the runtime on demand during the dev loop.
...
Switch channels (git + npm): `sunclaw update --channel stable|beta|dev`.
Details: [Development channels](https://docs.sunclaw.complex.az/install/development-channels).

## Agent workspace + skills

- Workspace root: `~/.sunclaw/workspace` (configurable via `agents.defaults.workspace`).
- Injected prompt files: `AGENTS.md`, `SOUL.md`, `TOOLS.md`.
- Skills: `~/.sunclaw/workspace/skills/<skill>/SKILL.md`.

## Configuration

Minimal `~/.sunclaw/sunclaw.json` (model + defaults):
...
[Full configuration reference (all keys + examples).](https://docs.sunclaw.complex.az/gateway/configuration)

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=sunclaw/sunclaw&type=date&legend=top-left)](https://www.star-history.com/#sunclaw/sunclaw&type=date&legend=top-left)

## Molty

SunClaw was built for **Molty**, a space lobster AI assistant. 🦞
by Peter Steinberger and the community.

- [docs.sunclaw.complex.az](https://docs.sunclaw.complex.az)
- [soul.md](https://soul.md)
- [steipete.me](https://steipete.me)
- [@sunclaw](https://x.com/sunclaw)
