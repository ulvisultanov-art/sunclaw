...
successCriteria:
  - The runtime-packaged bundled plugin tree is used as SUNCLAW_BUNDLED_PLUGINS_DIR.
          ...
          expr: |-
            (async () => {
              ...
              const cliEnv = {
                ...
                SUNCLAW_OAUTH_DIR: path.join(stateDir, "credentials"),
                SUNCLAW_BUNDLED_PLUGINS_DIR: distRuntimeExtensions,
