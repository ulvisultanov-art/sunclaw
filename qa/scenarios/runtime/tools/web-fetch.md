...
coverage:
  primary:
    - tools.web-fetch
objective: Verify web_fetch preserves arguments and result shape across SunClaw and Codex.
successCriteria:
...
execution:
  ...
  config:
    ...
    toolCoverage:
      ...
      reason: web_fetch is an SunClaw integration tool and must stay visible and callable under SunClaw and Codex direct runtime parity.
