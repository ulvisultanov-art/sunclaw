...
enum GatewaySettingsStore {
    private static let gatewayService = "ai.sunclaw.gateway"
    private static let nodeService = "ai.sunclaw.node"
    private static let talkService = "ai.sunclaw.talk"
...
enum GatewayDiagnostics {
    private static let logger = Logger(subsystem: "ai.sunclaw.ios", category: "GatewayDiag")
    private static let queue = DispatchQueue(label: "ai.sunclaw.gateway.diagnostics")
    ...
    private static var fileURL: URL? {
        FileManager.default.urls(for: .cachesDirectory, in: .userDomainMask).first?
            .appendingPathComponent("sunclaw-gateway.log")
    }
