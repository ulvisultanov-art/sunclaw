...
final class PhotoLibraryService: PhotosServicing {
    ...
    func latest(params: SunClawPhotosLatestParams) async throws -> SunClawPhotosLatestPayload {
        ...
        var results: [SunClawPhotoPayload] = []
        ...
        return SunClawPhotosLatestPayload(photos: results)
    }
    ...
    private static func renderAsset(
        ...
        maxWidth: Int,
        quality: Double,
        formatter: ISO8601DateFormatter) throws -> SunClawPhotoPayload
    {
