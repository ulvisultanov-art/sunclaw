# SunClaw iOS Changelog

## 2026.6.2 - 2026-06-02

Maintenance update for the current SunClaw release.
...
Maintenance update for the current SunClaw beta release.
...
Maintenance update for the current SunClaw development release.
...
First App Store release of SunClaw for iPhone. Pair with your SunClaw Gateway to use chat, voice, sharing, and device actions from iOS.
