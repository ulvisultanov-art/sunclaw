...
public typealias SunClawPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias SunClawPlatformImage = UIImage
#endif

public struct SunClawChatUsageCost: Codable, Hashable, Sendable {
...
public struct SunClawChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: SunClawChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(SunClawChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct SunClawChatMessageContent: Codable, Hashable, Sendable {
...
public struct SunClawChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [SunClawChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: SunClawChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [SunClawChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: SunClawChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        let decodedUsage = try container.decodeIfPresent(SunClawChatUsage.self, forKey: .usage)
        ...
        if let decoded = try? container.decode([SunClawChatMessageContent].self, forKey: .content) {
...
public struct SunClawChatHistoryPayload: Codable, Sendable {
...
public struct SunClawSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct SunClawSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [SunClawSessionPreviewItem]
}

public struct SunClawSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [SunClawSessionPreviewEntry]

    public init(ts: Int, previews: [SunClawSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct SunClawChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct SunClawChatCreateSessionResponse: Codable, Sendable {
    public let ok: Bool?
    public let key: String
    public let sessionId: String?
}

public struct SunClawChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct SunClawSessionMessageEventPayload: Codable, Sendable {
    public let sessionKey: String?
    public let agentId: String?
    public let message: SunClawChatMessage?
...
public struct SunClawAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct SunClawChatPendingToolCall: Identifiable, Hashable, Sendable {
    public var id: String {
        self.toolCallId
    }
...
public struct SunClawGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct SunClawPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: SunClawPlatformImage?
...
public struct SunClawChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
