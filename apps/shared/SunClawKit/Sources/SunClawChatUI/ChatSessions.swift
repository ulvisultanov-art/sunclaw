...
public struct SunClawChatThinkingLevelOption: Codable, Identifiable, Sendable, Hashable {
...
public struct SunClawChatModelChoice: Identifiable, Codable, Sendable, Hashable {
...
public struct SunClawChatSessionsDefaults: Codable, Sendable {
    public let modelProvider: String?
    public let model: String?
    public let contextTokens: Int?
    public let thinkingLevels: [SunClawChatThinkingLevelOption]?
    ...
    public init(
        ...
        model: String?,
        contextTokens: Int?,
        thinkingLevels: [SunClawChatThinkingLevelOption]? = nil,
...
public struct SunClawChatSessionEntry: Codable, Identifiable, Sendable, Hashable {
    public var id: String {
        self.key
    }
...
public struct SunClawChatSessionsListResponse: Codable, Sendable {
    public let ts: Double?
    public let path: String?
    public let count: Int?
    public let defaults: SunClawChatSessionsDefaults?
    public let sessions: [SunClawChatSessionEntry]
    ...
    public init(
        ...
        sessions: [SunClawChatSessionEntry])
    {
        self.ts = ts
        self.path = path
        self.count = count
