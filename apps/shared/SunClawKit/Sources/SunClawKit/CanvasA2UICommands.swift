...
public enum SunClawCanvasA2UICommand: String, Codable, Sendable {
...
public struct SunClawCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct SunClawCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
