...
public enum GatewayDeviceAuthPayload {
    ...
    public static func signedDeviceDictionary(
        ...
        signedAtMs: Int,
        nonce: String) -> [String: SunClawProtocol.AnyCodable]?
    {
        ...
        return [
            "id": SunClawProtocol.AnyCodable(identity.deviceId),
            "publicKey": SunClawProtocol.AnyCodable(publicKey),
            "signature": SunClawProtocol.AnyCodable(signature),
            "signedAt": SunClawProtocol.AnyCodable(signedAtMs),
            "nonce": SunClawProtocol.AnyCodable(nonce),
        ]
    }
}
