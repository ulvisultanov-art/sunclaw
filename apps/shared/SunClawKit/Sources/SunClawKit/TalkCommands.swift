...
public enum SunClawTalkCommand: String, Codable, Sendable {
...
public struct SunClawTalkPTTStartPayload: Codable, Sendable, Equatable {
...
public struct SunClawTalkPTTStopPayload: Codable, Sendable, Equatable {
    public var captureId: String
