...
public actor GatewayNodeSession {
    private let logger = Logger(subsystem: "ai.sunclaw", category: "node.gateway")
    ...
    {
        let timeoutLogger = Logger(subsystem: "ai.sunclaw", category: "node.gateway")
        let timeout: Int = {
    ...
    private func decodeInvokeRequest(from payload: SunClawProtocol.AnyCodable) throws -> NodeInvokeRequestPayload {
        do {
