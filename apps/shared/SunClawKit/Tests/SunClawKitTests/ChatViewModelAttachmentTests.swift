...
private struct AttachmentProcessingTransport: SunClawChatTransport {
    func requestHistory(sessionKey _: String) async throws -> SunClawChatHistoryPayload {
...
final class ChatViewModelAttachmentTests: XCTestCase {
    func testImageAttachmentsAreProcessedBeforeStaging() async throws {
        ...
        let viewModel = await MainActor.run {
            SunClawChatViewModel(sessionKey: "main", transport: AttachmentProcessingTransport())
        }
