...
@Suite struct GatewayErrorsTests {
    ...
    @Test func connectAuthErrorPreservesStructuredMetadata() {
        let error = GatewayConnectAuthError(
            ...
            actionCommand: "sunclaw devices approve req-123",
            docsURLString: "https://docs.sunclaw.complex.az/gateway/pairing",
        ...
        #expect(error.actionCommand == "sunclaw devices approve req-123")
        #expect(error.docsURLString == "https://docs.sunclaw.complex.az/gateway/pairing")
    ...
    @Test func pairingProblemUsesStructuredRequestMetadata() {
        ...
        #expect(problem?.actionCommand == "sunclaw devices approve req-123")
    }
