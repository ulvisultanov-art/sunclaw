...
struct SunClawApp: App {
    ...
    private static let logger = Logger(subsystem: "ai.sunclaw", category: "app")
    ...
    var body: some Scene {
        ...
        Window("SunClaw Settings", id: SettingsWindowOpener.windowID) {
    ...
    private func applyStatusItemAppearance(paused _: Bool, sleeping _: Bool) {
        ...
        self.statusItem?.button?.toolTip = self.state.voiceWakeMeterActive
            ? "SunClaw - Voice Wake live meter active"
            : "SunClaw"
    }
...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    private let webChatAutoLogger = Logger(subsystem: "ai.sunclaw", category: "Chat")
