...
enum UIStrings {
    static let welcomeTitle = "Welcome to SunClaw"
}
...
struct OnboardingView: View {
    ...
    @State var onboardingChatModel: SunClawChatViewModel
    ...
    var devLinkCommand: String {
        ...
        return "npm install -g sunclaw@\(version)"
    }
            ...
            filterLocalGateways: false))
    {
        ...
        self._onboardingChatModel = State(
            initialValue: SunClawChatViewModel(
