...
final class TalkMLXSpeechSynthesizer {
    ...
    private let logger = Logger(subsystem: "ai.sunclaw", category: "talk.mlx")
    ...
    func synthesize(
        ...
        let tempDir = FileManager.default.temporaryDirectory
            .appendingPathComponent("sunclaw-mlx-tts-\(token.uuidString)", isDirectory: true)
    ...
    private static func helperInvocation() -> HelperInvocation {
        ...
        if let override = ProcessInfo.processInfo.environment["SUNCLAW_MLX_TTS_BIN"], !override.isEmpty {
        ...
        if let executableDir = Bundle.main.executableURL?.deletingLastPathComponent() {
            let bundled = executableDir.appendingPathComponent("sunclaw-mlx-tts")
        ...
        return HelperInvocation(
            ...
            argumentPrefix: ["sunclaw-mlx-tts"],
            displayName: "sunclaw-mlx-tts")
    }
