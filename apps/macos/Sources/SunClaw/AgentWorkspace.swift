...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.sunclaw", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return SunClawConfigFile.defaultWorkspaceURL() }
