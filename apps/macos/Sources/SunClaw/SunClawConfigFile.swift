...
enum SunClawConfigFile {
    private static let logger = Logger(subsystem: "ai.sunclaw", category: "config")
    ...
    static func url() -> URL {
        SunClawPaths.configURL
    }

    static func stateDirURL() -> URL {
        SunClawPaths.stateDirURL
    }

    static func defaultWorkspaceURL() -> URL {
        SunClawPaths.workspaceURL
    }
    ...
    private static func appendConfigWriteAudit(_ fields: [String: Any]) {
        var record: [String: Any] = [
            ...
            "source": "macos-sunclaw-config-file",
            "event": "config.write",
