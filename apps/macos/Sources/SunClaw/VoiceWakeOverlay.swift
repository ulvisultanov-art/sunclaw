...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.sunclaw", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other SunClaw windows, but below the system’s pop-up menus.
