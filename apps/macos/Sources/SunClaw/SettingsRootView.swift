...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .sunclawSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? SunClawPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? SunClawPaths.stateDirURL.path
...
private struct SettingsTabGroup: Identifiable {
    ...
    static func defaultGroups(showDebug: Bool) -> [SettingsTabGroup] {
        var groups = [
            ...
            SettingsTabGroup(title: "SunClaw", tabs: [.about]),
        ]
...
extension Notification.Name {
    static let sunclawSelectSettingsTab = Notification.Name("sunclawSelectSettingsTab")
}
