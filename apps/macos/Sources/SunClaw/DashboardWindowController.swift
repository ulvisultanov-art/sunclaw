...
final class DashboardWindowController: NSWindowController, WKNavigationDelegate, NSWindowDelegate {
    ...
    private static func installNativeChromeScript(into userContentController: WKUserContentController) {
        let css = """
        html.sunclaw-native-macos {
          --sunclaw-native-titlebar-height: 50px;
        }
        @media (min-width: 700px) {
          html.sunclaw-native-macos .sidebar-shell {
            padding-top: max(14px, var(--sunclaw-native-titlebar-height)) !important;
          }
          html.sunclaw-native-macos .sidebar-shell__header {
        ...
        (() => {
          try {
            if (document.getElementById("sunclaw-native-macos-chrome")) return;
            const style = document.createElement("style");
            style.id = "sunclaw-native-macos-chrome";
            style.textContent = \(Self.jsStringLiteral(css));
            document.documentElement.classList.add("sunclaw-native-macos");
        ...
        auth: DashboardWindowAuth)
    {
        ...
        (() => {
          try {
            ...
            Object.defineProperty(window, "__SUNCLAW_NATIVE_CONTROL_AUTH__", {
              value: \(json),
              configurable: true,
            });
          } catch {}
