...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.sunclaw", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".sunclaw/disable-launchagent"
...
extension GatewayLaunchAgentManager {
        ...
        quiet: Bool) async -> CommandResult
    {
        ...
        #endif
        let command = CommandResolver.sunclawCommand(
            subcommand: "gateway",
