...
enum SessionMenuPreviewLoader {
    private static let logger = Logger(subsystem: "ai.sunclaw", category: "SessionPreview")
    ...
    private static func requestPreview(
        keys: [String],
        maxItems: Int) async throws -> SunClawSessionsPreviewPayload
    {
    ...
    private static func snapshot(
        from entry: SunClawSessionPreviewEntry,
    ...
    private static func cache(payload: SunClawSessionsPreviewPayload, maxItems: Int) async {
    ...
    private static func previewItems(
        from payload: SunClawChatHistoryPayload,
        maxItems: Int) -> [SessionPreviewItem]
    {
        let boundedItems = self.normalizeMaxItems(maxItems)
        let raw: [SunClawKit.AnyCodable] = payload.messages ?? []
    ...
    private static func decodeMessages(_ raw: [SunClawKit.AnyCodable]) -> [SunClawChatMessage] {
    ...
    private static func previewText(for message: SunClawChatMessage) -> String? {
    ...
    private static func isToolCall(_ message: SunClawChatMessage) -> Bool {
    ...
    private static func toolNames(for message: SunClawChatMessage) -> [String] {
        var names: [String] = []
    ...
    private static func mediaSummary(for message: SunClawChatMessage) -> String? {
