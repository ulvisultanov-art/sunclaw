...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/ulvisultanov-art/sunclaw") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/ulvisultanov-art/sunclaw")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://docs.sunclaw.complex.az")
            ...
            Text("© 2026 SunClaw Foundation — MIT License.")
                .font(.footnote)
                .foregroundStyle(.secondary)
                .padding(.top, 4)
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
            (Bundle.main.object(forInfoDictionaryKey: "SunClawBuildTimestamp") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SunClawBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "SunClawGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "SunClawGitCommit") as? String) ??
            "unknown"
    }
