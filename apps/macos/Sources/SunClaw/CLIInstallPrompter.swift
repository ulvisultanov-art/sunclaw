...
final class CLIInstallPrompter {
    ...
    private let logger = Logger(subsystem: "ai.sunclaw", category: "cli.prompt")
    ...
    func checkAndPromptIfNeeded(reason: String) {
        ...
        let alert = NSAlert()
        alert.messageText = "Install SunClaw CLI?"
    ...
    private func openSettings(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .sunclawSelectSettingsTab, object: tab)
        }
    }
