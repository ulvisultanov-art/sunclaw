...
struct MacGatewayChatTransportMappingTests {
    @Test func `snapshot maps to health`() {
        let snapshot = Snapshot(
            presence: [],
            health: SunClawProtocol.AnyCodable(["ok": SunClawProtocol.AnyCodable(false)]),
    ...
    @Test func `health event maps to health`() {
        let frame = EventFrame(
            type: "event",
            event: "health",
            payload: SunClawProtocol.AnyCodable(["ok": SunClawProtocol.AnyCodable(true)]),
            seq: 1,
            stateversion: nil)
    ...
    @Test func `chat event maps to chat`() {
        let payload = SunClawProtocol.AnyCodable([
            "runId": SunClawProtocol.AnyCodable("run-1"),
            "sessionKey": SunClawProtocol.AnyCodable("main"),
            "state": SunClawProtocol.AnyCodable("final"),
        ])
    ...
    @Test func `session message event maps to session message`() {
        let payload = SunClawProtocol.AnyCodable([
            "sessionKey": SunClawProtocol.AnyCodable("agent:main:main"),
            "messageId": SunClawProtocol.AnyCodable("msg-1"),
            "messageSeq": SunClawProtocol.AnyCodable(7),
            "message": SunClawProtocol.AnyCodable([
                "role": SunClawProtocol.AnyCodable("user"),
                "content": SunClawProtocol.AnyCodable([
                    SunClawProtocol.AnyCodable([
                        "type": SunClawProtocol.AnyCodable("text"),
                        "text": SunClawProtocol.AnyCodable("spoken transcript"),
                    ]),
                ]),
                "timestamp": SunClawProtocol.AnyCodable(1234.5),
            ]),
        ])
    ...
    @Test func `unknown event maps to nil`() {
        let frame = EventFrame(
            type: "event",
            event: "unknown",
            payload: SunClawProtocol.AnyCodable(["a": SunClawProtocol.AnyCodable(1)]),
            seq: 1,
            stateversion: nil)
        let mapped = MacGatewayChatTransport.mapPushToTransportEvent(.event(frame))
        #expect(mapped == nil)
