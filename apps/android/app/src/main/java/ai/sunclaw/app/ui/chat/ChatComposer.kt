...
import ai.sunclaw.app.ui.mobileAccentBorderStrong
...
import ai.sunclaw.app.ui.mobileHeadline
import ai.sunclaw.app.ui.mobileSurface
import ai.sunclaw.app.ui.mobileText
import ai.sunclaw.app.ui.mobileTextSecondary
import ai.sunclaw.app.ui.mobileTextTertiary
  ...
  Column(modifier = Modifier.fillMaxWidth(), verticalArrangement = Arrangement.spacedBy(8.dp)) {
    ...
    if (!healthOk) {
      Text(
        ...
        style = mobileCallout,
        color = ai.sunclaw.app.ui.mobileWarning,
      )
    }
...
private fun mobileBodyStyle() =
  MaterialTheme.typography.bodyMedium.copy(
    fontFamily = ai.sunclaw.app.ui.mobileFontFamily,
