...
fun CanvasScreen(
  ...
  AndroidView(
    ...
    factory = {
      ...
      if (isDebuggable) {
        Log.d("SunClawWebView", "userAgent: ${webSettings.userAgentString}")
      }
      ...
      webView.webViewClient =
        object : WebViewClient() {
          ...
          override fun onReceivedError(
            ...
            Log.e("SunClawWebView", "onReceivedError: ${error.errorCode} ${error.description} ${request.url}")
          }
          ...
          override fun onPageFinished(
            ...
            currentPageUrlRef.set(url)
            if (isDebuggable) {
              Log.d("SunClawWebView", "onPageFinished: $url")
            }
      ...
      if (WebViewFeature.isFeatureSupported(WebViewFeature.WEB_MESSAGE_LISTENER)) {
        ...
        Log.w("SunClawWebView", "WebMessageListener unsupported; canvas actions disabled")
      }
...
internal class CanvasA2UIActionBridge(
  ...
  companion object {
    const val interfaceName: String = "sunclawCanvasA2UIAction"
