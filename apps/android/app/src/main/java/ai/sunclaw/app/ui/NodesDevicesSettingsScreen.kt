...
import ai.sunclaw.app.GatewayDeviceTokenSummary
import ai.sunclaw.app.GatewayNodeSummary
import ai.sunclaw.app.GatewayNodesDevicesSummary
import ai.sunclaw.app.GatewayPairedDeviceSummary
import ai.sunclaw.app.GatewayPendingDeviceSummary
...
private fun nodeSubtitle(node: GatewayNodeSummary): String {
  ...
  val version = node.version?.let { "SunClaw $it" }
