...
import ai.sunclaw.app.gateway.GatewayClientInfo
import ai.sunclaw.app.gateway.GatewayConnectOptions
import ai.sunclaw.app.gateway.GatewayEndpoint
import ai.sunclaw.app.gateway.GatewayTlsParams
...
class ConnectionManager(
  ...
  fun buildUserAgent(): String {
    ...
    return "SunClawAndroid/$version (Android $releaseLabel; SDK ${Build.VERSION.SDK_INT})"
  }
  ...
  fun buildNodeConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      client = buildClientInfo(clientId = "sunclaw-android", clientMode = "node"),
  ...
  fun buildOperatorConnectOptions(): GatewayConnectOptions =
    GatewayConnectOptions(
      ...
      commands = emptyList(),
      permissions = emptyMap(),
      client = buildClientInfo(clientId = "sunclaw-android", clientMode = "ui"),
      userAgent = buildUserAgent(),
    )
