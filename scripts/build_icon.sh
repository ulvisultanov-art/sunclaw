...
# Defaults target the SunClaw assets so you can just run the script from repo root.
...
DEST_ICNS=${DEST_ICNS:-"$ROOT_DIR/apps/macos/Sources/SunClaw/Resources/SunClaw.icns"}
