...
if [[ -z "$version_content" ]]; then
  echo "<h2>SunClaw $VERSION</h2>"
  echo "<p>Latest SunClaw update.</p>"
  echo "<p><a href=\"https://github.com/ulvisultanov-art/sunclaw/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
