...
show_usage() {
    cat << EOF
clawlog - SunClaw Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View SunClaw logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    SunClaw logs flow through the macOS unified log (subsystem: ai.sunclaw).
