...
function clickClackHttpTimeoutMs() {
  return readPositiveInt(process.env.SUNCLAW_RELEASE_USER_JOURNEY_HTTP_TIMEOUT_MS, 5000);
}
...
function assertOnboard() {
  ...
  assert(fs.existsSync(configPath()), "onboard did not write sunclaw.json");
  const stateRaw =
