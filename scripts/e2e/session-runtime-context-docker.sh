...
IMAGE_NAME="$(docker_e2e_resolve_image "sunclaw-session-runtime-context-e2e" SUNCLAW_SESSION_RUNTIME_CONTEXT_E2E_IMAGE)"
CONTAINER_NAME="sunclaw-session-runtime-context-e2e-$$"
RUN_LOG="$(mktemp -t sunclaw-session-runtime-context-log.XXXXXX)"
