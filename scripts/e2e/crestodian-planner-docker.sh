...
IMAGE_NAME="$(docker_e2e_resolve_image "sunclaw-crestodian-planner-e2e" SUNCLAW_CRESTODIAN_PLANNER_E2E_IMAGE)"
CONTAINER_NAME="sunclaw-crestodian-planner-e2e-$$"
RUN_LOG="$(mktemp -t sunclaw-crestodian-planner-log.XXXXXX)"
...
SUNCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 crestodian-planner empty)"
