...
IMAGE_NAME="$(docker_e2e_resolve_image "sunclaw-openai-chat-tools-e2e" SUNCLAW_OPENAI_CHAT_TOOLS_E2E_IMAGE)"
SKIP_BUILD="${SUNCLAW_OPENAI_CHAT_TOOLS_E2E_SKIP_BUILD:-0}"
PORT="${SUNCLAW_OPENAI_CHAT_TOOLS_PORT:-18789}"
TOKEN="openai-chat-tools-e2e-$$"
PROFILE_FILE="${SUNCLAW_OPENAI_CHAT_TOOLS_PROFILE_FILE:-${SUNCLAW_TESTBOX_PROFILE_FILE:-$HOME/.sunclaw-testbox-live.profile}}"
...
SUNCLAW_TEST_STATE_SCRIPT_B64="$(docker_e2e_test_state_shell_b64 openai-chat-tools empty)"
...
docker_e2e_run_logged_with_harness openai-chat-tools \
  ...
  -e "SUNCLAW_OPENAI_CHAT_TOOLS_MODEL=${SUNCLAW_OPENAI_CHAT_TOOLS_MODEL:-openai/gpt-5.4-mini}" \
  -e "SUNCLAW_OPENAI_CHAT_TOOLS_TIMEOUT_SECONDS=${SUNCLAW_OPENAI_CHAT_TOOLS_TIMEOUT_SECONDS:-180}" \
