...
- SUNCLAW_IOS_VERSION = exact canonical iOS version
- SUNCLAW_MARKETING_VERSION = short iOS/App Store version
- SUNCLAW_BUILD_VERSION = explicit build number or local numeric fallback
EOF
}
...
SUNCLAW_IOS_VERSION = ${IOS_VERSION}
SUNCLAW_MARKETING_VERSION = ${MARKETING_VERSION}
SUNCLAW_BUILD_VERSION = ${BUILD_NUMBER}
EOF
