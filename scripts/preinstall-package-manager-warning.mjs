...
export function createPackageManagerWarningMessage(packageManager) {
  ...
  return [
    `[sunclaw] warning: detected ${packageManager} for install lifecycle.`,
    "[sunclaw] this repo works best with pnpm; npm-compatible installs are slower and much larger here.",
    "[sunclaw] prefer: corepack pnpm install",
  ].join("\n");
}
