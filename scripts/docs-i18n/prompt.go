...
- Keep product names in English: SunClaw, Raspberry Pi, WhatsApp, Telegram, Discord, iMessage, Slack, Microsoft Teams, Google Chat, Signal.
- For the SunClaw Gateway, use “Gateway 网关”.
