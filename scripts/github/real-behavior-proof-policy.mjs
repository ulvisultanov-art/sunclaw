...
const CLAWSWEEPER_BOT_LOGINS = new Set(["clawsweeper[bot]", "sunclaw-clawsweeper[bot]"]);
...
const liveCommandRegex =
  /\b(?:sunclaw|node|docker|curl|gh|ssh|adb|xcrun|xcodebuild|open|npm\s+run|pnpm\s+sunclaw)\b/i;
