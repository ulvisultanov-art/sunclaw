...
import { loadSunClawPluginCliRegistry, loadSunClawPlugins } from "./loader.js";
import {
...
describe("plugin loader CLI metadata", () => {
  it.each([
    ...
    async ({ id, kind, error }) => {
      ...
      const registry = await loadSunClawPluginCliRegistry({
        cache: false,
        logger: {
          info: () => {},
          warn: () => {},
  ...
  it("uses the real channel entry in cli-metadata mode for CLI metadata capture", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@sunclaw/cli-metadata-channel",
          sunclaw: { extensions: ["./index.cjs"], setupEntry: "./setup-entry.cjs" },
        },
        null,
        2,
      ),
...
module.exports = {
  ...
  it("skips bundled channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@sunclaw/bundled-skip-channel",
...
module.exports = {
  ...
  it("prefers bundled channel cli-metadata entries over full channel entries", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@sunclaw/bundled-cli-channel",
          sunclaw: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("skips bundled non-channel full entries that do not provide a dedicated cli-metadata entry", async () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@sunclaw/bundled-skip-provider",
          sunclaw: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("collects channel CLI metadata during full plugin loads", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@sunclaw/full-cli-metadata-channel",
          sunclaw: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("collects channel CLI metadata during discovery plugin loads", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@sunclaw/discovery-cli-metadata-channel",
          sunclaw: { extensions: ["./index.cjs"] },
        },
        null,
        2,
...
module.exports = {
  ...
  it("can force channel runtime entries for CLI registration when setup entries exist", () => {
    ...
    fs.writeFileSync(
      ...
      JSON.stringify(
        {
          name: "@sunclaw/force-runtime-cli-channel",
          sunclaw: { extensions: ["./index.cjs"], setupEntry: "./setup-entry.cjs" },
        },
        null,
        2,
