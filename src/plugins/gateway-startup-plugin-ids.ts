...
import { buildModelCatalogMergeKey } from "@sunclaw/model-catalog-core/model-catalog-refs";
...
function normalizePluginsConfigForInstalledIndex(
  config: SunClawConfig["plugins"] | undefined,
...
function listPotentialEnabledChannelIds(config: SunClawConfig, env: NodeJS.ProcessEnv): string[] {
...
function resolveGatewayStartupDreamingPluginIds(config: SunClawConfig): Set<string> {
...
function collectConfiguredWebSearchProviderIds(config: SunClawConfig): ReadonlySet<string> {
...
function collectConfiguredVoiceProviderIds(config: SunClawConfig): ConfiguredVoiceProviderIds {
...
function collectValidationHeartbeatTargetChannelIds(config: SunClawConfig): string[] {
...
function collectValidationChannelConfigIds(config: SunClawConfig): string[] {
...
function collectConfiguredProviderIds(config: SunClawConfig): string[] {
...
function collectValidationConfiguredProviderIds(config: SunClawConfig): string[] {
...
function collectValidationConfiguredShorthandModelIds(config: SunClawConfig): string[] {
  return sortUniquePluginIds(
