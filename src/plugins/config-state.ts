...
} & PluginActivationConfigSourceLike<SunClawConfig>;
...
const hasExplicitMemorySlot = (plugins?: SunClawConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.hasOwn(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: SunClawConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.hasOwn(plugins.entries, defaultSlotIdForKey("memory")));

export const hasExplicitPluginConfig = (plugins?: SunClawConfig["plugins"]) =>
