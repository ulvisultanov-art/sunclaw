...
import type { AnyAgentTool, SunClawPluginApi } from "./types.js";
...
describe("captured plugin registration", () => {
  ...
  it("returns synthetic scheduled-turn ids independent of human-readable names", async () => {
    let scheduleSessionTurn: SunClawPluginApi["scheduleSessionTurn"] | undefined;
    let registerSessionSchedulerJob: SunClawPluginApi["registerSessionSchedulerJob"] | undefined;
    const captured = capturePluginRegistration({
