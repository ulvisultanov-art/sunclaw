...
const resolveAuthAgentDir = (agentDir?: string, config?: SunClawConfig) =>
...
function resolveProviderDefaultEnvSecretRef(provider: string, config?: SunClawConfig): SecretRef {
