...
export function applyProviderDefaultModel(cfg: SunClawConfig, modelRef: string): SunClawConfig {
...
function buildOpenAICompatibleSelfHostedProviderConfig(params: {
  ...
  contextWindow?: number;
  maxTokens?: number;
}): { config: SunClawConfig; modelId: string; modelRef: string; profileId: string } {
