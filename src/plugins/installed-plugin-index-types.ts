...
export const INSTALLED_PLUGIN_INDEX_WARNING =
  "DO NOT EDIT. This file is generated by SunClaw from plugin manifests, install records, and config policy. Use `sunclaw plugins registry --refresh`, `sunclaw plugins install/update/uninstall`, or `sunclaw plugins enable/disable` instead.";
...
export type InstalledPluginIndexRecord = {
  ...
  /**
   * Package-authored sunclaw.install metadata. This describes catalog/package
