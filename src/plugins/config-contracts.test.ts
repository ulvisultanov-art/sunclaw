...
const mocks = vi.hoisted(() => {
  ...
  return {
    discoverSunClawPlugins: vi.fn(() => ({ candidates: [], diagnostics: [] })),
...
vi.mock("./discovery.js", () => ({
  discoverSunClawPlugins: mocks.discoverSunClawPlugins,
}));
...
function createPluginRecord(
  ...
  return {
    ...
    hooks: [],
    source: `/tmp/${overrides.id}/sunclaw.plugin.json`,
...
describe("resolvePluginConfigContractsById", () => {
  beforeEach(() => {
    mocks.discoverSunClawPlugins.mockReset();
    mocks.discoverSunClawPlugins.mockReturnValue({ candidates: [], diagnostics: [] });
