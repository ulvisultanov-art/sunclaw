...
import type { SunClawPluginService, SunClawPluginServiceContext } from "./types.js";
...
function expectServiceLogger(ctx: SunClawPluginServiceContext) {
...
function expectServiceContexts(
  contexts: SunClawPluginServiceContext[],
  config: Parameters<typeof startPluginServices>[0]["config"],
) {
...
describe("startPluginServices", () => {
  ...
  it("starts services and stops them in reverse order", async () => {
    const starts: string[] = [];
    const stops: string[] = [];
    const contexts: SunClawPluginServiceContext[] = [];
  ...
  it("grants internal diagnostics only to trusted diagnostics exporter services", async () => {
    ...
    const prometheusContexts: SunClawPluginServiceContext[] = [];
    ...
    const officialInstallContexts: SunClawPluginServiceContext[] = [];
    ...
    const untrustedContexts: SunClawPluginServiceContext[] = [];
    ...
    const spoofedContexts: SunClawPluginServiceContext[] = [];
