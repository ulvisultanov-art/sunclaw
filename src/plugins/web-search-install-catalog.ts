import { normalizeOptionalString as normalizeString } from "@sunclaw/normalization-core/string-coerce";
...
function getConfigPath(config: SunClawConfig | undefined, path: string): unknown {
...
function setConfigPath(target: SunClawConfig, path: string, value: unknown): void {
...
function buildProviderEntry(params: {
  ...
  return {
    ...
    applySelectionConfig: (config: SunClawConfig) =>
