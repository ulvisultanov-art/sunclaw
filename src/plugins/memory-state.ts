...
export type MemoryPluginRuntime = {
  ...
  closeMemorySearchManager?(params: { cfg: SunClawConfig; agentId: string }): Promise<void>;
...
export type MemoryPluginPublicArtifactsProvider = {
  listArtifacts(params: { cfg: SunClawConfig }): Promise<MemoryPluginPublicArtifact[]>;
};
