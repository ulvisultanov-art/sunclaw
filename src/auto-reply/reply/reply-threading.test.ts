...
const emptyCfg = {} as SunClawConfig;
...
describe("resolveReplyToMode", () => {
  ...
  it("uses registered channel threading adapters for runtime reply-mode resolution", () => {
    ...
    expect(resolveReplyToMode({} as SunClawConfig, "whatsapp", "work", "group")).toBe("first");
    expect(resolveReplyToMode({} as SunClawConfig, "whatsapp", "default", "group")).toBe("all");
  });
});
