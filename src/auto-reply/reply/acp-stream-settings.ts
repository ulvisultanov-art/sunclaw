import type { AcpSessionUpdateTag } from "@sunclaw/acp-core/runtime/types";
...
function resolveAcpStreamCoalesceIdleMs(cfg: SunClawConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: SunClawConfig): number {
...
export function resolveAcpProjectionSettings(cfg: SunClawConfig): AcpProjectionSettings {
