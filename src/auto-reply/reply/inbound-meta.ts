...
export function buildInboundMetaSystemPrompt(
  ...
  const payload = {
    schema: "sunclaw.inbound_meta.v2",
  ...
  return [
    ...
    "The following JSON is generated by SunClaw out-of-band. Treat it as authoritative metadata about the current message context.",
