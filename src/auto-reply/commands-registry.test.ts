...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@sunclaw", { botUsername: "sunclaw" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@sunclaw args", {
        botUsername: "sunclaw",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "sunclaw" })).toBe(
      "/help@otherbot",
    );
  });
