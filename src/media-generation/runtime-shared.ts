...
type CapabilityProviderCandidate = {
  ...
  isConfigured?: (ctx: { cfg?: SunClawConfig; agentDir?: string }) => boolean;
};
...
function resolveCurrentDefaultProviderId(cfg?: SunClawConfig): string {
...
function resolveAutoCapabilityFallbackRefs(params: {
  cfg: SunClawConfig;
  agentDir?: string;
  listProviders: (cfg?: SunClawConfig) => CapabilityProviderCandidate[];
}): string[] {
