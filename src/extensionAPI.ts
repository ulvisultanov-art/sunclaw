 ...
 * sunclaw/extension-api. Use the injected plugin runtime or focused
 * sunclaw/plugin-sdk subpaths instead.
 */

const shouldWarnExtensionApiImport =
  process.env.VITEST !== "true" &&
  process.env.NODE_ENV !== "test" &&
  process.env.SUNCLAW_SUPPRESS_EXTENSION_API_WARNING !== "1";

if (shouldWarnExtensionApiImport) {
  process.emitWarning(
    "sunclaw/extension-api is deprecated. Migrate to api.runtime.agent.* or focused sunclaw/plugin-sdk/<subpath> imports. See https://docs.sunclaw.complex.az/plugins/sdk-migration",
    {
      code: "SUNCLAW_EXTENSION_API_DEPRECATED",
      detail:
        "This compatibility bridge is temporary. Bundled plugins should use the injected plugin runtime instead of importing host-side agent helpers directly. Migration guide: https://docs.sunclaw.complex.az/plugins/sdk-migration",
    },
  );
}
