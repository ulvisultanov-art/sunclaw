...
export class AcpSessionManager {
  ...
  resolveSession(params: { cfg: SunClawConfig; sessionKey: string }): AcpSessionResolution {
  ...
  getObservabilitySnapshot(cfg: SunClawConfig): AcpManagerObservabilitySnapshot {
  ...
  private enforceConcurrentSessionLimit(params: { cfg: SunClawConfig; sessionKey: string }): void {
  ...
  private async evictIdleRuntimeHandles(cfg: SunClawConfig): Promise<void> {
