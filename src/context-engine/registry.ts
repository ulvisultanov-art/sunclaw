...
const LEGACY_SESSION_KEY_COMPAT = Symbol.for("sunclaw.contextEngine.sessionKeyCompat");
...
const CONTEXT_ENGINE_REGISTRY_STATE = Symbol.for("sunclaw.contextEngineRegistryState");
