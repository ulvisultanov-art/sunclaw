...
function listConfiguredChannelIds(cfg: SunClawConfig): string[] {
...
function listConfiguredChannelAccountIds(cfg: SunClawConfig, channelId: string): string[] {
  if (!hasRecord(cfg.channels)) {
    return [];
  }
...
export function collectChannelRouteTargets(cfg: SunClawConfig): ChannelRouteTarget[] {
