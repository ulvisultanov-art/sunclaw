...
describe("resolveOutboundSessionRoute", () => {
  ...
  const perChannelPeerCfg = { session: { dmScope: "per-channel-peer" } } as SunClawConfig;
  ...
  const perChannelPeerSessionCfg = { session: { dmScope: "per-channel-peer" } } as SunClawConfig;
