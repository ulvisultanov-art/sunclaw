...
function resolveSlackPluginOriginTarget(params: { cfg: SunClawConfig; turnSourceTo: string }) {
...
describe("exec approval session target", () => {
  ...
  it("returns null for blank session keys, missing entries, and unresolved targets", () => {
    withTempDirSync({ prefix: "sunclaw-exec-approval-session-target-" }, (tmpDir) => {
