  ...
  return withEnvAsync(
    {
      ...
      SUNCLAW_SERVICE_VERSION: undefined,
...
describe("system-presence version fallback", () => {
  ...
  it("uses runtime VERSION when SUNCLAW_VERSION is not set", async () => {
  ...
  it("prefers SUNCLAW_VERSION over runtime VERSION", async () => {
    await expectSelfVersion(
      {
  ...
  it("still prefers runtime VERSION over SUNCLAW_SERVICE_VERSION when SUNCLAW_VERSION is blank", async () => {
    await expectSelfVersion(
      {
        SUNCLAW_VERSION: " ",
        SUNCLAW_SERVICE_VERSION: "2.4.6-service",
  ...
  it("uses runtime VERSION when SUNCLAW_VERSION and SUNCLAW_SERVICE_VERSION are blank", async () => {
    await expectSelfVersion(
      {
        SUNCLAW_VERSION: " ",
        SUNCLAW_SERVICE_VERSION: "\t",
