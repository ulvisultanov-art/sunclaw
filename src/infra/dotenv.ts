...
const BLOCKED_WORKSPACE_DOTENV_KEYS = new Set([
  ...
  "SUNCLAW_OAUTH_DIR",
  "SUNCLAW_PINNED_PYTHON",
  "SUNCLAW_PINNED_WRITE_PYTHON",
  "SUNCLAW_PLUGIN_INSTALL_OVERRIDES",
...
const BLOCKED_WORKSPACE_DOTENV_PREFIXES = [
  ...
  "CLAWHUB_",
  "OPENAI_API_KEY_",
  // Workspace .env is untrusted; reserve the full SunClaw runtime namespace
  // for shell/global config so new SUNCLAW_* controls are fail-closed by default.
  "SUNCLAW_",
  "SUNCLAW_CLAWHUB_",
  "SUNCLAW_DISABLE_",
  "SUNCLAW_SKIP_",
...
export function loadDotEnv(opts?: { quiet?: boolean }) {
  ...
  // Then load global fallback: ~/.sunclaw/.env (or SUNCLAW_STATE_DIR/.env),
