...
export const DEFAULT_SANDBOX_IMAGE = "sunclaw-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "sunclaw-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "sunclaw-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "sunclaw-sandbox-common:bookworm-slim";
...
export const DEFAULT_SANDBOX_BROWSER_PREFIX = "sunclaw-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "sunclaw-sandbox-browser";
