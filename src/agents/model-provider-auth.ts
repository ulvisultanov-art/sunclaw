...
const configFingerprintCache = new WeakMap<SunClawConfig, string>();
...
function resolveProviderAuthConfigFingerprint(cfg: SunClawConfig | undefined): string | null {
  if (!cfg) {
    return null;
  }
...
function collectProviderAuthWarmRuntimeAuthLookups(cfg: SunClawConfig): {
