...
function findMutableAgentEntry(cfg: SunClawConfig, agentId: string): AgentConfig | undefined {
...
export function resolveAgentModelPrimary(cfg: SunClawConfig, agentId: string): string | undefined {
