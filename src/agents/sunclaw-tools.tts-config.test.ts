...
import { testing, createSunClawTools } from "./sunclaw-tools.js";
...
const mocks = vi.hoisted(() => {
  ...
  return {
    ...
    textToSpeech: vi.fn(async () => ({
      success: true,
      audioPath: "/tmp/sunclaw/tts-config-test.opus",
      provider: "microsoft",
...
vi.mock("./sunclaw-plugin-tools.js", () => ({
  resolveSunClawPluginToolsForOptions: () => [],
}));

vi.mock("./sunclaw-tools.nodes-workspace-guard.js", () => ({
...
describe("createSunClawTools TTS config wiring", () => {
  beforeEach(() => {
...
describe("createSunClawTools media generation session wiring", () => {
  beforeEach(() => {
    mocks.createImageGenerateToolOptions.mockClear();
    mocks.createMusicGenerateToolOptions.mockClear();
    mocks.createVideoGenerateToolOptions.mockClear();
...
describe("createSunClawTools session status route context wiring", () => {
  beforeEach(() => {
...
describe("createSunClawTools cron context wiring", () => {
  beforeEach(() => {
    mocks.createCronToolOptions.mockClear();
  });
