...
vi.mock("../../plugins/manifest-metadata-scan.js", () => ({
  listSunClawPluginManifestMetadata: manifestMocks.listSunClawPluginManifestMetadata,
}));
...
function setManifestPlugins(plugins: unknown[]) {
  ...
  manifestMocks.listSunClawPluginManifestMetadata.mockReturnValue(
  ...
  manifestMocks.loadPluginManifest.mockImplementation((pluginDir: string) => {
    ...
    return plugin
      ...
      : { ok: false, error: "missing manifest", manifestPath: `${pluginDir}/sunclaw.plugin.json` };
  });
}
...
beforeEach(() => {
  manifestMocks.listSunClawPluginManifestMetadata.mockReset();
