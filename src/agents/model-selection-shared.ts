...
function listModelAliasCandidates(cfg: SunClawConfig): ModelAliasCandidate[] {
...
export function hasConfiguredProviderModelRows(cfg: SunClawConfig): boolean {
...
export function parseConfiguredModelVisibilityEntries(params: { cfg?: SunClawConfig }): {
