...
export function resolveSunClawPluginToolsForOptions(params: {
  options?: ResolveSunClawPluginToolsOptions;
  ...
  const resolveApiKeyForProvider = authProfileStore
    ...
    : undefined;
  const pluginToolInputs = resolveSunClawPluginToolInputs({
