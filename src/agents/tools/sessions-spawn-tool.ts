...
// Keep the schema local to avoid a circular import through acp-spawn/sunclaw-tools.
...
function resolveAcpUnavailableMessage(opts?: { sandboxed?: boolean; config?: SunClawConfig }) {
