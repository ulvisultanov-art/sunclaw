...
function hasExplicitDefaultPrimaryModel(cfg?: SunClawConfig): boolean {
...
function pickMaxBytes(cfg?: SunClawConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  const providerCfg: SunClawConfig = effectiveCfg ?? {};
