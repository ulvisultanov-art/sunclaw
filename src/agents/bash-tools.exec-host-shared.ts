...
export function buildHeadlessExecApprovalDeniedMessage(params: {
  ...
  return [
    ...
    "Stricter values from tools.exec and ~/.sunclaw/exec-approvals.json both apply.",
    "Fix one of these:",
    ...
    'Tip: run "sunclaw doctor" and "sunclaw approvals get --gateway" to inspect the effective policy.',
  ].join("\n");
}
