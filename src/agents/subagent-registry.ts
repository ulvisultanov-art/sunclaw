...
const STALE_ACTIVE_SUBAGENT_GRACE_MS = process.env.SUNCLAW_TEST_FAST === "1" ? 1_000 : 60_000;
...
function resolveSubagentWaitTimeoutMs(cfg: SunClawConfig, runTimeoutSeconds?: number) {
