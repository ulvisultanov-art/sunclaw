...
type ChannelConfigAccessorParams<Config extends SunClawConfig = SunClawConfig> = {
  cfg: Config;
  accountId?: string | null;
};
...
type MultiAccountChannelConfigAdapterParams<
  ...
  Config extends SunClawConfig = SunClawConfig,
> = {
  sectionKey: string;
...
export function adaptScopedAccountAccessor<Result, Config extends SunClawConfig = SunClawConfig>(
...
> {
  const base = {
    resolveAllowFrom({ cfg, accountId }: { cfg: SunClawConfig; accountId?: string | null }) {
...
function setTopLevelChannelEnabledInConfigSection<Config extends SunClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  enabled: boolean;
}): Config {
...
function removeTopLevelChannelConfigSection<Config extends SunClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
}): Config {
...
function clearTopLevelChannelConfigFields<Config extends SunClawConfig>(params: {
  cfg: Config;
  sectionKey: string;
  clearBaseFields: string[];
}): Config {
