...
/**
 * @deprecated Compatibility facade for the `sunclaw/plugin-sdk/discord` subpath.
...
export type { SunClawPluginApi, PluginRuntime } from "./channel-plugin-common.js";
...
export type DiscordAccountConfig = NonNullable<NonNullable<SunClawConfig["channels"]>["discord"]>;
...
type DiscordApiFacadeModule = {
  ...
  inspectDiscordAccount: (params: { cfg: SunClawConfig; accountId?: string | null }) => unknown;
  listDiscordAccountIds: (cfg: SunClawConfig) => string[];
  ...
  resolveDefaultDiscordAccountId: (cfg: SunClawConfig) => string;
...
function resolveCompatRuntimeConfig(params: { cfg?: SunClawConfig }): SunClawConfig {
...
export function listDiscordAccountIds(cfg: SunClawConfig): string[] {
...
export function resolveDefaultDiscordAccountId(cfg: SunClawConfig): string {
