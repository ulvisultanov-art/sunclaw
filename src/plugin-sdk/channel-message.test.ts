...
describe("defineChannelMessageAdapter", () => {
  const loadPluginSdkSubpaths = async () =>
    await Promise.all([
      import("sunclaw/plugin-sdk/channel-outbound"),
      import("sunclaw/plugin-sdk/channel-message"),
      import("sunclaw/plugin-sdk/channel-message-runtime"),
      import("sunclaw/plugin-sdk/channel-reply-pipeline"),
      import("sunclaw/plugin-sdk/compat"),
    ] as const);
