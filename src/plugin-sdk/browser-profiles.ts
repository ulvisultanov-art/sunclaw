...
export const DEFAULT_SUNCLAW_BROWSER_ENABLED = true;
export const DEFAULT_BROWSER_EVALUATE_ENABLED = true;
export const DEFAULT_SUNCLAW_BROWSER_COLOR = "#FF4500";
export const DEFAULT_SUNCLAW_BROWSER_PROFILE_NAME = "sunclaw";
export const DEFAULT_BROWSER_DEFAULT_PROFILE_NAME = "sunclaw";
export const DEFAULT_BROWSER_ACTION_TIMEOUT_MS = 60_000;
export const DEFAULT_AI_SNAPSHOT_MAX_CHARS = 80_000;
export const DEFAULT_UPLOAD_DIR = path.join(resolvePreferredSunClawTmpDir(), "uploads");
