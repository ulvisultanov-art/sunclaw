...
export function installSunClawOwnedToolHooks(params?: {
 ...
 * Pair with `installSunClawOwnedToolHooks()` when a test asserts before/after hook behavior.
 */
...
export function resetSunClawOwnedToolHooks(): void {
  resetGlobalHookRunner();
  resetPluginRuntimeStateForTest();
