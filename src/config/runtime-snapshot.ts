...
let runtimeConfigSnapshot: SunClawConfig | null = null;
let runtimeConfigSourceSnapshot: SunClawConfig | null = null;
...
function configSnapshotsMatch(left: SunClawConfig, right: SunClawConfig): boolean {
  if (left === right) {
    return true;
  }
  try {
...
export function hashRuntimeConfigValue(value: SunClawConfig): string {
...
export function getRuntimeConfigSourceSnapshot(): SunClawConfig | null {
...
export function resolveRuntimeConfigCacheKey(config: SunClawConfig): string {
...
export function selectApplicableRuntimeConfig(params: {
  inputConfig?: SunClawConfig;
  runtimeConfig?: SunClawConfig | null;
  runtimeSourceConfig?: SunClawConfig | null;
...
export function loadPinnedRuntimeConfig(loadFresh: () => SunClawConfig): SunClawConfig {
...
export async function preflightRuntimeSnapshotWrite(params: {
  nextSourceConfig: SunClawConfig;
