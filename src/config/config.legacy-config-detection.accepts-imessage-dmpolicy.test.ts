...
function expectSunClawSchemaInvalidPreservesField(params: {
  config: unknown;
  ...
  const res = SunClawSchema.safeParse(params.config);
...
describe("legacy config detection", () => {
  ...
  it("rejects removed legacy provider sections", () => {
    expectSunClawSchemaInvalidPreservesField({
  ...
  it("preserves claude-cli auth profile mode during validation", () => {
    ...
    const res = SunClawSchema.safeParse(config);
