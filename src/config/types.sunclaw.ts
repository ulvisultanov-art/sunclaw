...
export type SunClawConfig = {
  $schema?: string;
  meta?: {
    /** Last SunClaw version that wrote this config. */
  ...
  ui?: {
    /** Accent color for SunClaw UI chrome (hex). */
    seamColor?: string;
    assistant?: {
...
export type SunClawConfigInput = Omit<SunClawConfig, "models"> & {
  models?: ModelsConfigInput;
};

declare const sunClawConfigStateBrand: unique symbol;

type BrandedConfigState<TState extends string> = SunClawConfig & {
  readonly [sunClawConfigStateBrand]?: TState;
};
