...
function createCustomRootCfg(customRoot: string, defaultAgentId = "ops"): SunClawConfig {
  return {
    session: {
...
const discoveryResolvers = [
  {
    label: "async",
    resolve: async (cfg: SunClawConfig, env: NodeJS.ProcessEnv) =>
