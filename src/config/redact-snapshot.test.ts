...
import type { ConfigFileSnapshot } from "./types.sunclaw.js";
...
describe("redactConfigSnapshot", () => {
          ...
          plugins: [
            {
              ...
              manifestPath: "/private/plugin/root/sunclaw.plugin.json",
            },
          ],
          diagnostics: [],
        },
  ...
  it("does not redact passwordFile path fields", () => {
    const snapshot = makeSnapshot({
      channels: {
        irc: {
          passwordFile: "/etc/sunclaw/irc-password.txt",
          nickserv: {
            passwordFile: "/etc/sunclaw/nickserv-password.txt",
    ...
    expect(irc.passwordFile).toBe("/etc/sunclaw/irc-password.txt");
    expect(nickserv.passwordFile).toBe("/etc/sunclaw/nickserv-password.txt");
