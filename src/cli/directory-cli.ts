    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["sunclaw directory self --channel slack", "Show the connected account identity."],
          [
            'sunclaw directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["sunclaw directory groups list --channel discord", "List available groups/channels."],
          [
            "sunclaw directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.sunclaw.complex.az/cli/directory",
        )}\n`,
    )
    .action(() => {
