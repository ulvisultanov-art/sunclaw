...
function resolveFetchConfig(config: SunClawConfig): Record<string, unknown> | undefined {
...
function resolveSearchConfig(config: SunClawConfig): Record<string, unknown> | undefined {
...
function getCapabilityWebSearchAutoDetectTargets(config: SunClawConfig): CommandSecretTargetScope {
...
function getCapabilityWebFetchAutoDetectTargets(config: SunClawConfig): CommandSecretTargetScope {
  return getCapabilityWebProviderAutoDetectTargets({
    config,
...
function isScopedChannelSecretTargetEntry(params: {
  ...
  return (
    ...
    params.entry.configFile === "sunclaw.json" &&
...
type CapabilityWebCommandSecretTargetParams = {
  ...
  autoDetectTargets: (config: SunClawConfig) => CommandSecretTargetScope;
  selectedProviderTargetIds: (
    config: SunClawConfig,
    providerId?: string | null,
  ) => SelectedProviderTargetIds;
