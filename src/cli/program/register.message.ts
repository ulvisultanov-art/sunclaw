...
${formatHelpExamples([
  ['sunclaw message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'sunclaw message send --target +15555550123 --message "Hi" --media photo.jpg',
    "Send a message with media.",
  ],
  [
    'sunclaw message poll --channel discord --target channel:123 --poll-question "Snack?" --poll-option Pizza --poll-option Sushi',
    "Create a Discord poll.",
  ],
  [
    'sunclaw message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.sunclaw.complex.az/cli/message")}`,
    )
    .action(() => {
