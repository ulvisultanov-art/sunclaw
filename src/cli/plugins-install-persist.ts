...
function addInstalledPluginToAllowlist(cfg: SunClawConfig, pluginId: string): SunClawConfig {
...
function removeInstalledPluginFromDenylist(cfg: SunClawConfig, pluginId: string): SunClawConfig {
  ...
  params.runtime.log(
    theme.warn(
      [
        ...
        "Run `sunclaw plugins doctor` for repair options.",
      ].join("\n"),
    ),
  );
}
