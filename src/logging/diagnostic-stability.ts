...
function getDiagnosticStabilityState(): DiagnosticStabilityState {
  const globalStore = globalThis as typeof globalThis & {
    __sunclawDiagnosticStabilityState?: DiagnosticStabilityState;
  };
  globalStore["__sunclawDiagnosticStabilityState"] ??= createState();
  return globalStore["__sunclawDiagnosticStabilityState"];
}
...
export function resetDiagnosticStabilityRecorderForTest(): void {
  ...
  globalStore["__sunclawDiagnosticStabilityState"] = next;
}
