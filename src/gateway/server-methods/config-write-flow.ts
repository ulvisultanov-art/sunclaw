...
export function didSharedGatewayAuthChange(prev: SunClawConfig, next: SunClawConfig): boolean {
...
}): Promise<{ path: string; config: SunClawConfig; queueFollowUp: () => void }> {
