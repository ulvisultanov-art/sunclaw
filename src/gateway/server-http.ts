        ...
        wss.handleUpgrade(req, socket, head, (ws) => {
          (
            ws as unknown as import("ws").WebSocket & {
              __sunclawPreauthBudgetClaimed?: boolean;
              __sunclawPreauthBudgetKey?: string;
            }
          )["__sunclawPreauthBudgetKey"] = preauthBudgetKey;
