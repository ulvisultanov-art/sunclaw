...
export function hasAmbiguousGatewayAuthModeConfig(cfg: SunClawConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: SunClawConfig): void {
