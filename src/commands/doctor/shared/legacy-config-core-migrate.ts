...
function pruneBindingsForMissingAgents(cfg: SunClawConfig, changes: string[]): SunClawConfig {
...
export function normalizeCompatibilityConfigValues(cfg: SunClawConfig): {
