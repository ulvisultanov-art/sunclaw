...
export function collectMissingDefaultAccountBindingWarnings(cfg: SunClawConfig): string[] {
...
export function collectMissingExplicitDefaultAccountWarnings(cfg: SunClawConfig): string[] {
  const warnings: string[] = [];
