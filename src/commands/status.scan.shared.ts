...
function hasExplicitMemorySearchConfig(cfg: SunClawConfig, agentId: string): boolean {
...
export function resolveMemoryPluginStatus(cfg: SunClawConfig): MemoryPluginStatus {
...
export async function resolveSharedMemoryStatusSnapshot(params: {
  ...
  resolveMemoryConfig: (cfg: SunClawConfig, agentId: string) => { store: { path: string } } | null;
