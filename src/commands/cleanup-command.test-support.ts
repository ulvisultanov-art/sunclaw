...
export function resetCleanupCommandMocks() {
  ...
  resolveCleanupPlanFromDisk.mockReturnValue({
    stateDir: "/tmp/.sunclaw",
    configPath: "/tmp/.sunclaw/sunclaw.json",
    oauthDir: "/tmp/.sunclaw/credentials",
    configInsideState: true,
    oauthInsideState: true,
    workspaceDirs: ["/tmp/.sunclaw/workspace"],
  });
  removePath.mockResolvedValue({ ok: true });
  listAgentSessionDirs.mockResolvedValue(["/tmp/.sunclaw/agents/main/sessions"]);
