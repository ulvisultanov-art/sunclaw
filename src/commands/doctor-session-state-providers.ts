...
import { normalizeStringEntriesLower } from "@sunclaw/normalization-core/string-normalization";
...
function resolveSessionAgentId(cfg: SunClawConfig, sessionKey: string): string {
