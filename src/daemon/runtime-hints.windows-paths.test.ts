...
const resolveGatewayLogPathsMock = vi.fn(() => ({
  logDir: "C:\\tmp\\sunclaw-state\\logs",
  stdoutPath: "C:\\tmp\\sunclaw-state\\logs\\gateway.log",
  stderrPath: "C:\\tmp\\sunclaw-state\\logs\\gateway.err.log",
}));
const resolveGatewaySupervisorLogPathsMock = vi.fn(() => ({
  logDir: "C:\\Users\\test\\Library\\Logs\\sunclaw",
  stdoutPath: "C:\\Users\\test\\Library\\Logs\\sunclaw\\gateway.log",
  stderrPath: "C:\\Users\\test\\Library\\Logs\\sunclaw\\gateway.err.log",
}));
const resolveGatewayRestartLogPathMock = vi.fn(
  () => "C:\\tmp\\sunclaw-state\\logs\\gateway-restart.log",
);
