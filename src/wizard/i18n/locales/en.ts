...
export const en = {
  ...
  wizard: {
    ...
    gateway: {
      ...
      plaintextPasswordHint: "Stores the password directly in SunClaw config",
    ...
    migration: {
      ...
      complete: "Migration complete. Run `sunclaw doctor` next.",
    ...
    plugins: {
      ...
      sensitiveField:
        '"{label}" is sensitive. Set it via:\n  sunclaw config set plugins.entries.{plugin}.config.{field} <value>\nor use the Web UI Settings page.',
    ...
    remote: {
      ...
      insecureRemoteUrl:
        "Use wss:// for remote hosts, or ws://127.0.0.1/localhost via SSH tunnel. Break-glass: SUNCLAW_ALLOW_INSECURE_PRIVATE_WS=1 for trusted private networks.",
      ...
      plaintextPasswordHint: "Stores the password directly in SunClaw config",
      plaintextPasswordLabel: "Enter password now",
      plaintextTokenHint: "Stores the token directly in SunClaw config",
    ...
    security: {
      ...
      beta: "SunClaw is a hobby project and still in beta. Expect sharp edges.",
      confirm:
        "I understand this is personal-by-default and shared/multi-user use requires lock-down. Continue?",
      hardeningRequired:
        "If you're not comfortable with security hardening and access control, don't run SunClaw.",
      learnMore: "Learn more",
      notMultitenant: "SunClaw is not a hostile multi-tenant boundary by default.",
      personalAgent: "By default, SunClaw is a personal agent: one trusted operator boundary.",
    ...
    skills: {
      ...
      docsLine: "Docs: https://docs.sunclaw.complex.az/skills",
      enterEnv: "Enter {env}",
    ...
    nextcloudTalk: {
      ...
      helpInstallCommand:
        '2) Run: ./occ talk:bot:install "SunClaw" "<shared-secret>" "<webhook-url>" --feature webhook --feature response --feature reaction',
    ...
    whatsapp: {
      ...
      ownerNumberNote: "We need the sender/owner number so SunClaw can allowlist you.",
      ...
      separatePhoneLabel: "Separate phone just for SunClaw",
    ...
    irc: {
      ...
      nextStatusCommand: "Command: sunclaw channels status --probe",
    ...
    synologyChat: {
      ...
      incomingWebhookHelpReplies: "This is the URL SunClaw uses to send replies back to Chat.",
    ...
    signal: {
      ...
      multipleEntries: "Multiple entries: comma-separated.",
      nextLinkDevice: 'Link device with: signal-cli link -n "SunClaw"',
    ...
    twitch: {
      ...
      envPrompt: "Twitch env var SUNCLAW_TWITCH_ACCESS_TOKEN detected. Use env token?",
      ...
      helpEnvVars: "Env vars supported: SUNCLAW_TWITCH_ACCESS_TOKEN",
    ...
    channelsPrimer: {
      ...
      blurbs: {
        ...
        synologyChat: "Connect your Synology NAS Chat to SunClaw with full agent capabilities.",
    ...
    search: {
      ...
      configured: "configured",
      configureLaterHint: "Configure later with sunclaw configure --section web",
      docsLine: "Docs: {url}",
    ...
    finalize: {
      ...
      controlUiDocs: "Docs: https://docs.sunclaw.complex.az/web/control-ui",
      dashboardCopyPaste: "Copy/paste this URL in a browser on this machine to control SunClaw.",
      dashboardLinkWithToken: "Dashboard link (with token): {url}",
      dashboardOpened: "Opened in your browser. Keep that tab to control SunClaw.",
      ...
      gatewayTokenStored:
        "Stored in: $SUNCLAW_CONFIG_PATH (default: ~/.sunclaw/sunclaw.json) under gateway.auth.token, or in SUNCLAW_GATEWAY_TOKEN.",
      ...
      outroDashboardLink: "Onboarding complete. Use the dashboard link above to control SunClaw.",
      outroDashboardOpened:
        "Onboarding complete. Dashboard opened; keep that tab to control SunClaw.",
      outroSeeded:
      ...
      restart: "Restart",
      securityReminder:
        "Running agents on your computer is risky — harden your setup: https://docs.sunclaw.complex.az/security",
      ...
      webDocs: "Docs: https://docs.sunclaw.complex.az/tools/web",
      ...
      whatNow: 'What now: https://docs.sunclaw.complex.az/showcase ("What People Are Building").',
      whatNowTitle: "What now",
      workspaceBackupTitle: "Workspace backup",
      workspaceDocs: "Docs: https://docs.sunclaw.complex.az/concepts/agent-workspace",
