...
export type ChannelSetupWizardEnvShortcut = {
  ...
  isAvailable: (params: { cfg: SunClawConfig; accountId: string }) => boolean;
  apply: (params: {
    cfg: SunClawConfig;
    accountId: string;
...
export type ChannelSetupWizardGroupAccess = {
  ...
  currentPolicy: (params: { cfg: SunClawConfig; accountId: string }) => ChannelAccessPolicy;
  currentEntries: (params: { cfg: SunClawConfig; accountId: string }) => string[];
  updatePrompt: (params: { cfg: SunClawConfig; accountId: string }) => boolean;
  setPolicy: (params: {
    cfg: SunClawConfig;
    accountId: string;
...
export type ChannelSetupWizard = {
  ...
  disable?: (cfg: SunClawConfig) => SunClawConfig;
...
export type ChannelOnboardingPostWriteHook = {
  channel: ChannelId;
  accountId: string;
  run: (ctx: { cfg: SunClawConfig; runtime: RuntimeEnv }) => Promise<void> | void;
};
...
export type ChannelSetupDmPolicy = {
  ...
  getCurrent: (cfg: SunClawConfig, accountId?: string) => DmPolicy;
  setPolicy: (cfg: SunClawConfig, policy: DmPolicy, accountId?: string) => SunClawConfig;
