...
function resolveRealtimeVoiceProviderEntries(cfg?: SunClawConfig): RealtimeVoiceProviderPlugin[] {
...
export function listRealtimeVoiceProviders(cfg?: SunClawConfig): RealtimeVoiceProviderPlugin[] {
