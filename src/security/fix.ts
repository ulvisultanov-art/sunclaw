...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SunClawConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SunClawConfig; env: NodeJS.ProcessEnv }): {
  cfg: SunClawConfig;
  changes: string[];
} {
