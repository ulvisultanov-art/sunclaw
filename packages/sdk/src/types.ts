...
export type ConnectableSunClawTransport = SunClawTransport & {
  connect(): Promise<void>;
};

export type RuntimeSelection =
  | "auto"
  | { type: "embedded"; id: "sunclaw" | "codex" | (string & {}) }
...
export type SunClawEvent<TData = unknown> = {
  version: 1;
  id: string;
  ts: number;
