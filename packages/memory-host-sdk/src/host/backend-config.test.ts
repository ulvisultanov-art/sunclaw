...
import type { SunClawConfig } from "./config-utils.js";
...
const rootMemoryConfig = (workspaceDir: string): SunClawConfig =>
  ({
    agents: {
...
describe("resolveMemoryBackendConfig", () => {
  it("defaults to builtin backend when config missing", () => {
    const cfg = { agents: { defaults: { workspace: "/tmp/memory-test" } } } as SunClawConfig;
